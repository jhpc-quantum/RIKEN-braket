...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
      ...
      {
        ::ket::mpi::utility::log_with_time_guard<char> print("CNOT", environment);
...
# ifndef BOOST_NO_CXX14_GENERIC_LAMBDAS
        return ::ket::mpi::utility::for_each_local_range(
          ...
          [parallel_policy, target_qubit, control_qubit, &permutation](
...
# ifdef BOOST_NO_CXX14_GENERIC_LAMBDAS
        template <typename ParallelPolicy, typename TargetQubit, typename ControlQubit>
        struct call_conj_controlled_not
        {
          ParallelPolicy parallel_policy_;
          TargetQubit target_qubit_;
          ControlQubit control_qubit_;

          call_conj_controlled_not(
            ParallelPolicy const parallel_policy,
            TargetQubit const target_qubit, ControlQubit const control_qubit)
            : parallel_policy_(parallel_policy),
              target_qubit_(target_qubit), control_qubit_(control_qubit)
        ...
        template <typename ParallelPolicy, typename TargetQubit, typename ControlQubit>
        inline call_conj_controlled_not<ParallelPolicy, TargetQubit, ControlQubit>
        make_call_conj_controlled_not(
          ParallelPolicy const parallel_policy,
          TargetQubit const target_qubit, ControlQubit const control_qubit)
        {
          return call_conj_controlled_not<ParallelPolicy, TargetQubit, ControlQubit>(
            parallel_policy, target_qubit, control_qubit);
        }
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
      }
      ...
      inline RandomAccessRange& conj_controlled_not(
        ...
        yampi::environment const& environment)
      {
        ::ket::mpi::utility::log_with_time_guard<char> print("Conj(CNOT)", environment);
...
# else // BOOST_NO_CXX14_GENERIC_LAMBDAS
        return ::ket::mpi::utility::for_each_local_range(
          mpi_policy, local_state,
          ::ket::mpi::gate::controlled_not_detail::make_call_conj_controlled_not(
            parallel_policy,
            permutation[target_qubit],
            ::ket::make_control(permutation[control_qubit.qubit()])));
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
      ...
      inline RandomAccessRange& conj_controlled_not(
        ...
        yampi::environment const& environment)
      {
        return ::ket::mpi::gate::conj_controlled_not(
          ::ket::mpi::utility::policy::make_general_mpi(),
          ::ket::utility::policy::make_sequential(),
          local_state, target_qubit, control_qubit, permutation,
          buffer, datatype, communicator, environment);
...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
      ...
      inline RandomAccessRange& adj_controlled_not(
        ...
        yampi::environment const& environment)
      {
        ::ket::mpi::utility::log_with_time_guard<char> print("Adj(CNOT)", environment);
