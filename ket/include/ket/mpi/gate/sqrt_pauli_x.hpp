#ifndef KET_MPI_GATE_SQRT_PAULI_X_HPP
# define KET_MPI_GATE_SQRT_PAULI_X_HPP
...
# include <ket/mpi/gate/page/sqrt_pauli_x.hpp>
    ...
    namespace gate
    {
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::is_on_page(permutated_qubit, local_state))
            return ::ket::mpi::gate::page::sqrt_pauli_x(parallel_policy, local_state, permutated_qubit);

          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_qubit](auto const first, auto const last)
            { ::ket::gate::sqrt_pauli_x(parallel_policy, first, last, permutated_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::any_on_page(local_state, permutation[target_qubit], permutation[control_qubit1], permutation[control_qubit2], permutation[control_qubits]...))
          {
            ...
            ::ket::mpi::gate::local::dispatch::transpage_sqrt_pauli_x<local_state_type>::call(
      ...
      namespace sqrt_pauli_x_detail
      {
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::gate::local::sqrt_pauli_x(
      ...
      -> RandomAccessRange&
      {
        ::ket::mpi::utility::log_with_time_guard<char> print{
          ::ket::mpi::gate::detail::append_qubits_string(std::string(sizeof...(ControlQubits), 'C').append("sX"), target_qubit, control_qubits...),
          environment};

        return ::ket::mpi::gate::sqrt_pauli_x_detail::sqrt_pauli_x(
          mpi_policy, parallel_policy,
          local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits...);
      }
      ...
      -> RandomAccessRange&
      {
        return ::ket::mpi::gate::sqrt_pauli_x(
      ...
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::is_on_page(permutated_qubit, local_state))
            return ::ket::mpi::gate::page::adj_sqrt_pauli_x(parallel_policy, local_state, permutated_qubit);

          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_qubit](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_x(parallel_policy, first, last, permutated_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          {
            if (::ket::mpi::page::is_on_page(permutated_control_qubit, local_state))
              return ::ket::mpi::gate::page::adj_sqrt_pauli_cx_tcp(
                parallel_policy, local_state, permutated_target_qubit, permutated_control_qubit);

            return ::ket::mpi::gate::page::adj_sqrt_pauli_cx_tp(
              parallel_policy, local_state, permutated_target_qubit, permutated_control_qubit);
          }
          else if (::ket::mpi::page::is_on_page(permutated_control_qubit, local_state))
            return ::ket::mpi::gate::page::adj_sqrt_pauli_cx_cp(
              parallel_policy, local_state, permutated_target_qubit, permutated_control_qubit);

          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_target_qubit, permutated_control_qubit](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_x(parallel_policy, first, last, permutated_target_qubit.qubit(), permutated_control_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          {
            using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
            ::ket::mpi::gate::local::dispatch::transpage_adj_sqrt_pauli_x<local_state_type>::call(
              parallel_policy, local_state,
              permutation[target_qubit], permutation[control_qubit1],
              permutation[control_qubit2], permutation[control_qubits]...);
          }
      ...
      namespace sqrt_pauli_x_detail
      {
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::gate::local::adj_sqrt_pauli_x(
            mpi_policy, parallel_policy, local_state, permutation, communicator, environment, target_qubit, control_qubits...);
        }
      ...
      {
        ::ket::mpi::utility::log_with_time_guard<char> print{
          ::ket::mpi::gate::detail::append_qubits_string(std::string{"Adj("}.append(sizeof...(ControlQubits), 'C').append("sX)"), target_qubit, control_qubits...),
          environment};

        return ::ket::mpi::gate::sqrt_pauli_x_detail::adj_sqrt_pauli_x(
          mpi_policy, parallel_policy,
          local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits...);
      }
      ...
      -> RandomAccessRange&
      {
        return ::ket::mpi::gate::adj_sqrt_pauli_x(
          ::ket::mpi::utility::policy::make_simple_mpi(),
          ::ket::utility::policy::make_sequential(),
          local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits...);
      }
      ...
      namespace runtime
      {
        namespace local
        {
          ...
          -> RandomAccessRange&
          {
            ...
            {
              using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
              return ::ket::mpi::gate::runtime::local::dispatch::transpage_sqrt_pauli_x<local_state_type>::call(
            ...
            return ::ket::mpi::utility::for_each_local_range(
              ...
              {
                ::ket::gate::runtime::qubit_ranges::sqrt_pauli_x(
          ...
          -> RandomAccessRange&
          {
            ...
            {
              using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
              return ::ket::mpi::gate::runtime::local::dispatch::transpage_adj_sqrt_pauli_x<local_state_type>::call(
                parallel_policy, local_state, permutated_target_qubit, permutated_control_qubits);
            }
            ...
            return ::ket::mpi::utility::for_each_local_range(
              ...
              [parallel_policy, permutated_target_qubit, permutated_control_qubits](auto const first, auto const last)
              {
                ::ket::gate::runtime::qubit_ranges::adj_sqrt_pauli_x(
                  parallel_policy, first, last, permutated_target_qubit.qubit(),
                  permutated_control_qubits | boost::adaptors::transformed(
                    [](typename ::ket::utility::meta::range_value_t<decltype(permutated_control_qubits)> const permutated_control_qubit)
                    { return permutated_control_qubit.qubit(); }));
        ...
        namespace sqrt_pauli_x_detail
        {
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::local::sqrt_pauli_x(
              mpi_policy, parallel_policy, local_state, permutation, communicator, environment, target_qubit, control_qubits);
          }
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::local::adj_sqrt_pauli_x(
              mpi_policy, parallel_policy, local_state, permutation, communicator, environment, target_qubit, control_qubits);
          }
        ...
        namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                std::string(num_control_qubits, 'C').append("sX"), target_qubit, control_qubits),
              environment};

            return ::ket::mpi::gate::runtime::sqrt_pauli_x_detail::sqrt_pauli_x(
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::ranges::sqrt_pauli_x(
              mpi_policy, parallel_policy, local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits);
          }
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                std::string{"Adj("}.append(num_control_qubits, 'C').append("sX)"), target_qubit, control_qubits),
              environment};

            return ::ket::mpi::gate::runtime::sqrt_pauli_x_detail::adj_sqrt_pauli_x(
              mpi_policy, parallel_policy, local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits);
          }
          ...
          -> RandomAccessRange&
          {
            using control_qubit_type = ::ket::control< ::ket::qubit<StateInteger, BitInteger> >;
            std::array<control_qubit_type, 0u> const control_qubits{};
            return ::ket::mpi::gate::runtime::ranges::adj_sqrt_pauli_x(
              mpi_policy, parallel_policy, local_state, permutation, buffer, communicator, environment, target_qubit, control_qubits);
          }
        ...
        inline auto sqrt_pauli_x(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        { return ::ket::mpi::gate::runtime::ranges::sqrt_pauli_x(mpi_policy, parallel_policy, local_state, permutation, buffer, communicator, environment, target_qubit); }
        ...
        inline auto sqrt_pauli_x(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        { return ::ket::mpi::gate::runtime::ranges::sqrt_pauli_x(mpi_policy, parallel_policy, local_state, permutation, buffer, datatype, communicator, environment, target_qubit); }
        ...
        inline auto adj_sqrt_pauli_x(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        { return ::ket::mpi::gate::runtime::ranges::adj_sqrt_pauli_x(mpi_policy, parallel_policy, local_state, permutation, buffer, communicator, environment, target_qubit); }
        ...
        inline auto adj_sqrt_pauli_x(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        { return ::ket::mpi::gate::runtime::ranges::adj_sqrt_pauli_x(mpi_policy, parallel_policy, local_state, permutation, buffer, datatype, communicator, environment, target_qubit); }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::sqrt_pauli_x(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_sqrt_pauli_x(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
...
#endif // KET_MPI_GATE_SQRT_PAULI_X_HPP
