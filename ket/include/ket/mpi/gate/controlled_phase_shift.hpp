    ...
    namespace gate
    {
      ...
      -> RandomAccessRange&
      {
        ...
        return ::ket::mpi::gate::phase_shift_detail::phase_shift(
          mpi_policy, parallel_policy,
          local_state, permutation, buffer, communicator, environment,
          phase, control_qubit1, control_qubit2, control_qubits...);
      }
