  ...
  namespace mpi
  {
    namespace gate
    {
      ...
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::any_on_page(local_state, permutation[qubit1], permutation[qubit2], permutation[qubit3], permutation[qubits]...))
          {
            ...
            ::ket::mpi::gate::local::dispatch::transpage_exponential_pauli_y_coeff<local_state_type>::call(
      ...
      template <
        ...
        typename StateInteger, typename BitInteger,
        typename Allocator, typename BufferAllocator>
      [[deprecated]] inline auto exponential_pauli_y_coeff(
        MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
        RandomAccessRange& local_state,
        Complex const& phase_coefficient, // exp(i theta) = cos(theta) + i sin(theta)
        ::ket::qubit<StateInteger, BitInteger> const qubit,
      ...
      template <
        ...
        typename StateInteger, typename BitInteger,
        typename Allocator, typename BufferAllocator>
      [[deprecated]] inline auto adj_exponential_pauli_y_coeff(
        MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
        RandomAccessRange& local_state,
        Complex const& phase_coefficient, // exp(i theta) = cos(theta) + i sin(theta)
        ::ket::qubit<StateInteger, BitInteger> const qubit,
      ...
      template <
        ...
        typename StateInteger, typename BitInteger,
        typename Allocator, typename BufferAllocator>
      [[deprecated]] inline auto exponential_pauli_y(
        MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
        RandomAccessRange& local_state,
        Real const phase,
        ::ket::qubit<StateInteger, BitInteger> const qubit,
      ...
      template <
        ...
        typename StateInteger, typename BitInteger,
        typename Allocator, typename BufferAllocator>
      [[deprecated]] inline auto adj_exponential_pauli_y(
        MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
        RandomAccessRange& local_state,
        Real const phase,
        ::ket::qubit<StateInteger, BitInteger> const qubit,
      ...
      namespace runtime
      {
        namespace local
        {
          ...
          -> RandomAccessRange&
          {
            ...
            {
              using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
              return ::ket::mpi::gate::runtime::local::dispatch::transpage_exponential_pauli_y_coeff<local_state_type>::call(
                parallel_policy, local_state, phase_coefficient,
                permutated_target_qubits, permutated_control_qubits);
            }
        ...
        namespace exponential_pauli_y_detail
        {
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::local::exponential_pauli_y_coeff(
              mpi_policy, parallel_policy,
        ...
        namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string(num_control_qubits, 'C').append("e").append(num_target_qubits, 'Y'), "(coeff) ", phase_coefficient),
                target_qubits, control_qubits),
              environment};

            return ::ket::mpi::gate::runtime::exponential_pauli_y_detail::exponential_pauli_y_coeff(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              phase_coefficient, target_qubits, control_qubits);
          }
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::ranges::exponential_pauli_y_coeff(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              phase_coefficient, target_qubits, control_qubits);
          }
        ...
        namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string{"Adj("}.append(num_control_qubits, 'C').append("e").append(num_target_qubits, 'Y').append("(coeff)) "),
                  phase_coefficient),
                target_qubits, control_qubits),
              environment};
          ...
          -> RandomAccessRange&
          {
            ...
            using control_qubit_type = ::ket::control<qubit_type>;
            std::array<control_qubit_type, 0u> const control_qubits{};
            return ::ket::mpi::gate::runtime::ranges::adj_exponential_pauli_y_coeff(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              phase_coefficient, target_qubits, control_qubits);
          }
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string(num_control_qubits, 'C').append("e").append(num_target_qubits, 'Y').append(" "), phase),
                target_qubits, control_qubits),
              environment};
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string{"Adj("}.append(num_control_qubits, 'C').append("e").append(num_target_qubits, 'Y').append(") "), phase),
                target_qubits, control_qubits),
              environment};
          ...
          -> RandomAccessRange&
          {
            ...
            using control_qubit_type = ::ket::control<qubit_type>;
            std::array<control_qubit_type, 0u> const control_qubits{};
            return ::ket::mpi::gate::runtime::ranges::exponential_pauli_y(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
          ...
          -> RandomAccessRange&
          {
            ...
            using control_qubit_type = ::ket::control<qubit_type>;
            std::array<control_qubit_type, 0u> const control_qubits{};
            return ::ket::mpi::gate::runtime::ranges::adj_exponential_pauli_y(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              phase, target_qubits, control_qubits);
          }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::exponential_pauli_y_coeff(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_exponential_pauli_y_coeff(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::exponential_pauli_y(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_exponential_pauli_y(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
