      ...
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::any_on_page(local_state, permutation[target_qubit], permutation[control_qubit1], permutation[control_qubit2], permutation[control_qubits]...))
          {
            ...
            return ::ket::mpi::gate::local::dispatch::transpage_controlled_v_coeff<local_state_type>::call(
      ...
      namespace runtime
      {
        ...
        namespace local
        {
          ...
          namespace dispatch
          {
            ...
            struct transpage_controlled_v_coeff
            {
              ...
              [[noreturn]] static auto call(
                ...
                Complex const& phase_coefficient, // exp(i theta) = cos(theta) + i sin(theta)
                ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
                PermutatedControlQubitsRange const& control_qubits)
              -> RandomAccessRange&
              { throw 1; }
            }; // struct transpage_controlled_v_coeff<LocalState>
          } // namespace dispatch
          ...
          -> RandomAccessRange&
          {
            ...
            {
              using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
              return ::ket::mpi::gate::runtime::local::dispatch::transpage_controlled_v_coeff<local_state_type>::call(
                parallel_policy, local_state, phase_coefficient,
                permutated_target_qubit, permutated_control_qubits);
            }
              ...
              [parallel_policy, &phase_coefficient, permutated_target_qubit, permutated_control_qubits](auto const first, auto const last)
              {
                ::ket::gate::runtime::qubit_ranges::controlled_v_coeff(
                  ...
                  permutated_control_qubits | boost::adaptors::transformed(
                    [](::ket::mpi::permutated<control_qubit_type> const permutated_control_qubit)
        ...
        namespace controlled_v_detail
        {
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::local::controlled_v_coeff(
              mpi_policy, parallel_policy,
              local_state, permutation, communicator, environment,
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string(num_control_qubits + std::size_t{1u}, 'C').append("v(coeff) "), phase_coefficient),
                target_qubit, control_qubits),
              environment};

            return ::ket::mpi::gate::runtime::controlled_v_detail::controlled_v_coeff(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              phase_coefficient, target_qubit, control_qubits);
          }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::ranges::controlled_v_coeff(
            mpi_policy, parallel_policy,
            local_state, permutation, buffer, communicator, environment,
...
namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string{"Adj("}.append(num_control_qubits + std::size_t{1u}, 'C').append("v(coeff)) "), phase_coefficient),
                target_qubit, control_qubits),
              environment};
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::ranges::adj_controlled_v_coeff(
            mpi_policy, parallel_policy,
            local_state, permutation, buffer, communicator, environment,
            phase_coefficient, target_qubit,
            boost::make_iterator_range(control_qubit_first, control_qubit_last));
...
namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string(num_control_qubits + std::size_t{1u}, 'C').append("v "), phase),
                target_qubit, control_qubits),
              environment};
            ...
            typename MpiPolicy, typename ParallelPolicy,
            typename RandomAccessRange, typename StateInteger, typename BitInteger,
            typename Allocator, typename BufferAllocator, typename DerivedDatatype, typename Real, typename ControlQubitsRange>
          inline auto controlled_v(
            MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
            RandomAccessRange& local_state,
            ::ket::mpi::qubit_permutation<StateInteger, BitInteger, Allocator>& permutation,
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string{"Adj("}.append(num_control_qubits + std::size_t{1u}, 'C').append("v) "), phase),
                target_qubit, control_qubits),
              environment};
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::ranges::controlled_v(
            mpi_policy, parallel_policy,
            local_state, permutation, buffer, communicator, environment,
            phase, target_qubit,
            boost::make_iterator_range(control_qubit_first, control_qubit_last));
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::ranges::adj_controlled_v(
            mpi_policy, parallel_policy,
            local_state, permutation, buffer, communicator, environment,
            phase, target_qubit,
            boost::make_iterator_range(control_qubit_first, control_qubit_last));
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::controlled_v_coeff(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_controlled_v_coeff(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::controlled_v(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_controlled_v(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
