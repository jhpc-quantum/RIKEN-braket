...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
        ...
        inline RandomAccessRange& do_y_rotation_half_pi(
...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit, ControlQubits const... control_qubits)
        {
          ...
          return ::ket::mpi::gate::y_rotation_half_pi_detail::do_y_rotation_half_pi(
...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
        ...
        template <
          ...
          typename RandomAccessRange,
          typename StateInteger, typename BitInteger, typename Allocator>
        inline RandomAccessRange& do_adj_y_rotation_half_pi(
          MpiPolicy const& mpi_policy, ParallelPolicy const parallel_policy,
          RandomAccessRange& local_state,
          ::ket::mpi::qubit_permutation<StateInteger, BitInteger, Allocator>& permutation,
          yampi::communicator const& communicator, yampi::environment const& environment,
...
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit, ControlQubits const... control_qubits)
        {
          ...
          return ::ket::mpi::gate::y_rotation_half_pi_detail::do_adj_y_rotation_half_pi(
            mpi_policy, parallel_policy, local_state, permutation, communicator, environment, target_qubit, control_qubits...);
        }
