#ifndef KET_MPI_GATE_DETAIL_SQRT_PAULI_Z_STANDARD_HPP
# define KET_MPI_GATE_DETAIL_SQRT_PAULI_Z_STANDARD_HPP
...
# include <ket/mpi/gate/page/sqrt_pauli_z_standard.hpp>
    ...
    namespace gate
    {
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::utility::for_each_local_range(
            ...
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            ...
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last, permutated_control_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::is_on_page(permutated_control_qubit1, local_state))
          {
            ...
            return ::ket::mpi::gate::page::sqrt_pauli_cz_p(
              parallel_policy, local_state, permutated_control_qubit2, permutated_control_qubit1);

          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_control_qubit1, permutated_control_qubit2](auto const first, auto const last)
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last, permutated_control_qubit1.qubit(), permutated_control_qubit2.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::any_on_page(local_state, permutation[control_qubit1], permutation[control_qubit2], permutation[control_qubit3], permutation[control_qubits]...))
          {
            ...
            ::ket::mpi::gate::local::dispatch::transpage_sqrt_pauli_z<local_state_type>::call(
              parallel_policy, local_state,
              permutation[control_qubit1], permutation[control_qubit2],
              permutation[control_qubit3], permutation[control_qubits]...);
          }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            ...
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last, permutated_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            ...
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last, permutated_qubit1.qubit(), permutated_qubit2.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            ...
            { ::ket::gate::sqrt_pauli_z(parallel_policy, first, last, permutated_target_qubit.qubit(), permutated_control_qubit.qubit()); });
        }
      ...
      -> RandomAccessRange&
      {
        ::ket::mpi::utility::log_with_time_guard<char> print{
          ::ket::mpi::gate::detail::append_qubits_string(std::string(std::max(sizeof...(Qubits), std::size_t{1u}) - std::size_t{1u}, 'C').append("sZ"), control_qubits...),
          environment};
      ...
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_control_qubit](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last, permutated_control_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_control_qubit1, permutated_control_qubit2](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last, permutated_control_qubit1.qubit(), permutated_control_qubit2.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          {
            using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
            ::ket::mpi::gate::local::dispatch::transpage_adj_sqrt_pauli_z<local_state_type>::call(
              parallel_policy, local_state,
              permutation[control_qubit1], permutation[control_qubit2],
              permutation[control_qubit3], permutation[control_qubits]...);
          }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_qubit](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last, permutated_qubit.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_qubit1, permutated_qubit2](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last, permutated_qubit1.qubit(), permutated_qubit2.qubit()); });
        }
        ...
        -> RandomAccessRange&
        {
          ...
          return ::ket::mpi::utility::for_each_local_range(
            mpi_policy, local_state, communicator, environment,
            [parallel_policy, permutated_target_qubit, permutated_control_qubit](auto const first, auto const last)
            { ::ket::gate::adj_sqrt_pauli_z(parallel_policy, first, last, permutated_target_qubit.qubit(), permutated_control_qubit.qubit()); });
        }
...
#endif // KET_MPI_GATE_DETAIL_SQRT_PAULI_Z_STANDARD_HPP
