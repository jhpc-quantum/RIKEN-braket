  ...
  namespace mpi
  {
    namespace gate
    {
      ...
      inline auto adj_phase_shift_coeff(
        ...
        yampi::communicator const& communicator, yampi::environment const& environment,
        Complex const& phase_coefficient,
        ::ket::control< ::ket::qubit<StateInteger, BitInteger> > const control_qubit, Qubits const... control_qubits)
      -> RandomAccessRange&
      {
        return ::ket::mpi::gate::adj_phase_shift_coeff(
          ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
      ...
      inline auto phase_shift(
        ...
        yampi::datatype_base<DerivedDatatype> const& datatype,
        yampi::communicator const& communicator, yampi::environment const& environment,
        Real const phase, ::ket::control< ::ket::qubit<StateInteger, BitInteger> > const control_qubit, Qubits const... control_qubits)
      -> RandomAccessRange&
      {
        ::ket::mpi::utility::log_with_time_guard<char> print{
          ::ket::mpi::gate::detail::append_qubits_string(
