...
# ifdef BOOST_NO_CXX11_LAMBDAS
          ...
          struct clear_loop1_inside
          {
            ...
            void operator()(StateInteger const index, int const) const
            {
              typedef
                ...
                complex_type;
              *(one_first_+index) = static_cast<complex_type>(0);
          ...
          template <typename Real, typename RandomAccessIterator>
          inline clear_loop1_inside<Real, RandomAccessIterator> make_clear_loop1_inside(
            Real& zero_probability,
            RandomAccessIterator const zero_first,
            RandomAccessIterator const one_first)
          {
            typedef
              ::ket::mpi::gate::page::clear_detail::clear_loop1_inside<Real, RandomAccessIterator>
              result_type;

            return result_type(zero_probability, zero_first, one_first);
          }
          ...
          struct clear_loop2_inside
          {
            ...
            clear_loop2_inside(
              ...
              : zero_first_(zero_first), multiplier_(multiplier)
            { }
          ...
          template <typename RandomAccessIterator, typename Real>
          inline clear_loop2_inside<RandomAccessIterator, Real> make_clear_loop2_inside(
            RandomAccessIterator const zero_first, Real const multiplier)
          {
            typedef
              ::ket::mpi::gate::page::clear_detail::clear_loop2_inside<RandomAccessIterator, Real>
              result_type;

            return result_type(zero_first, multiplier);
          }
...
# ifndef BOOST_NO_CXX11_LAMBDAS
            ...
            loop_n(
              ...
              {
                *(one_first+index) = static_cast<Complex>(0);
...
# else // BOOST_NO_CXX11_LAMBDAS
            ...
            loop_n(
              parallel_policy,
              boost::size(zero_page_range),
              ::ket::mpi::gate::page::clear_detail::make_clear_loop1_inside(
                zero_probability, boost::begin(zero_page_range), boost::begin(one_page_range)));
# endif // BOOST_NO_CXX11_LAMBDAS
          }
...
# else // BOOST_NO_CXX11_LAMBDAS
            ...
            loop_n(
              parallel_policy,
              boost::size(zero_page_range),
              ::ket::mpi::gate::page::clear_detail::make_clear_loop2_inside(
                boost::begin(zero_page_range), multiplier));
# endif // BOOST_NO_CXX11_LAMBDAS
          }
