        ...
        namespace detail
        {
          namespace exponential_pauli_z2_p_detail
          {
            ...
            -> ::ket::mpi::state<Complex, true, Allocator>&
            {
              ...
              auto const nonpage_permutated_qubit_mask
                = StateInteger{1u}
                  << (nonpage_permutated_qubit - least_permutated_unit_qubit);
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::exponential_pauli_z2_p_detail::exponential_pauli_z_coeff2_p_l(
                parallel_policy, local_state, phase_coefficient, page_permutated_qubit, nonpage_permutated_qubit);

            return ::ket::mpi::gate::page::detail::exponential_pauli_z2_p_detail::exponential_pauli_z_coeff2_p_g(
              parallel_policy,
              local_state, phase_coefficient, page_permutated_qubit, nonpage_permutated_qubit,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::exponential_pauli_z2_p_detail::exponential_pauli_z_coeff2_p_u(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_EXPONENTIAL_PAULI_Z2_P_DIAGONAL_HPP
