        ...
        namespace detail
        {
          ...
          namespace two_page_qubits_gate_detail
          {
              ...
              Function&& function)
            {
              ...
              assert(local_state.is_page_qubit(permutated_qubit1));
              assert(local_state.is_page_qubit(permutated_qubit2));
                   ...
                   page_id_wo_qubits < num_pages / 4u; ++page_id_wo_qubits)
              {
                ...
                // x0_2x1_1x
                auto const page_id_01 = page_id_00 bitor qubit1_mask;
                // x1_2x0_1x
                auto const page_id_10 = page_id_00 bitor qubit2_mask;
                // x1_2x1_1x
                auto const page_id_11 = page_id_10 bitor qubit1_mask;

                auto page_range_00 = local_state.page_range(page_id_00);
                ...
                auto page_range_10 = local_state.page_range(page_id_10);
          ...
          inline ::ket::mpi::state<Complex, num_page_qubits_, StateAllocator>& two_page_qubits_gate(
            ...
            Function&& function)
          {
            return ::ket::mpi::gate::page::detail::two_page_qubits_gate_detail::two_page_qubits_gate<num_nonpage_qubits>(
              mpi_policy, parallel_policy, local_state,
              target_qubit, control_qubit.qubit(),
            ...
            Function&& function)
          {
            return ::ket::mpi::gate::page::detail::two_page_qubits_gate_detail::two_page_qubits_gate<num_nonpage_qubits>(
              mpi_policy, parallel_policy, local_state,
              control_qubit1.qubit(), control_qubit2.qubit(),
              permutation, std::forward<Function>(function));
          }
        } // namespace detail
      } // namespace page
