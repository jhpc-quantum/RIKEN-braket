    ...
    namespace gate
    {
      namespace page
      {
        namespace detail
        {
          ...
          [[noreturn]] inline ::ket::mpi::state<Complex, 0, Allocator>& two_page_qubits_gate(
            ParallelPolicy const,
          ...
          template <
            ...
            typename ParallelPolicy,
            typename Complex, typename Allocator, typename Qubit1, typename Qubit2, typename Function>
          [[noreturn]] inline ::ket::mpi::state<Complex, 1, Allocator>& two_page_qubits_gate(
            ParallelPolicy const,
          ...
          template <
            ...
            typename Qubit1, typename Qubit2, typename Function>
          inline ::ket::mpi::state<Complex, num_page_qubits_, Allocator>& two_page_qubits_gate(
