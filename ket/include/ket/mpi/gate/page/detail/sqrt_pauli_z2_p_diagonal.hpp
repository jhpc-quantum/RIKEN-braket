#ifndef KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_Z2_P_DIAGONAL_HPP
# define KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_Z2_P_DIAGONAL_HPP
      ...
      namespace page
      {
        namespace detail
        {
          namespace sqrt_pauli_z2_p_detail
          {
            ...
            -> ::ket::mpi::state<Complex, true, Allocator>&
            {
              ...
              return ::ket::mpi::gate::page::detail::one_page_qubit_gate<1u>(
                  ...
                  auto const zero_first, auto const one_first, StateInteger const index_wo_nonpage_qubit, int const)
                {
                  ...
                  *iter_01_or_10 *= ::ket::utility::imaginary_unit<Complex>();
                  *iter_10_or_01 *= ::ket::utility::imaginary_unit<Complex>();
            ...
            [[noreturn]] inline auto sqrt_pauli_z2_p_u(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"sqrt_pauli_z2_p_cu"}; }

            template <
              typename StateInteger, typename BitInteger, typename NumProcesses,
              typename ParallelPolicy, typename Complex, typename Allocator>
            inline auto sqrt_pauli_z2_p_u(
              ::ket::mpi::utility::policy::unit_mpi<StateInteger, BitInteger, NumProcesses> const& mpi_policy,
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const page_permutated_qubit,
                ...
                if ((unit_qubit_value bitand nonpage_permutated_qubit_mask) == StateInteger{0u})
                  ...
                  for (auto page_index_wo_qubit = std::size_t{0u}; page_index_wo_qubit < num_pages / 2u; ++page_index_wo_qubit)
                  {
                    ...
                    ::ket::utility::loop_n(
                      ...
                      {
                        *(zero_first + index) *= ::ket::utility::imaginary_unit<Complex>();
                        using real_type = ::ket::utility::meta::real_t<Complex>;
          ...
          [[noreturn]] inline auto sqrt_pauli_z2_p(
            ...
            yampi::rank const)
          -> RandomAccessRange&
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"sqrt_pauli_z2_p"}; }
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::sqrt_pauli_z2_p_detail::sqrt_pauli_z2_p_l(
                parallel_policy, local_state, page_permutated_qubit, nonpage_permutated_qubit);

            return ::ket::mpi::gate::page::detail::sqrt_pauli_z2_p_detail::sqrt_pauli_z2_p_g(
              parallel_policy,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::sqrt_pauli_z2_p_detail::sqrt_pauli_z2_p_u(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_Z2_P_DIAGONAL_HPP
