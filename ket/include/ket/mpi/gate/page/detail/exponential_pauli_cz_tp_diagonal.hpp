#ifndef KET_MPI_GATE_PAGE_DETAIL_EXPONENTIAL_PAULI_CZ_TP_DIAGONAL_HPP
# define KET_MPI_GATE_PAGE_DETAIL_EXPONENTIAL_PAULI_CZ_TP_DIAGONAL_HPP
...
# ifdef BOOST_NO_CXX14_GENERIC_LAMBDAS
            ...
            struct do_exponential_pauli_cz_coeff_tp_cl
            {
              ...
              do_exponential_pauli_cz_coeff_tp_cl(
            ...
            }; // struct do_exponential_pauli_cz_coeff_tp_cl<Complex, StateInteger>

            template <typename Complex, typename StateInteger>
            inline ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::do_exponential_pauli_cz_coeff_tp_cl<Complex, StateInteger>
            make_do_exponential_pauli_cz_coeff_tp_cl(
              Complex const& phase_coefficient, Complex const& conj_phase_coefficient,
              StateInteger const permutated_control_qubit_mask,
              StateInteger const nonpage_lower_bits_mask,
              StateInteger const nonpage_upper_bits_mask)
            { return {phase_coefficient, conj_phase_coefficient, permutated_control_qubit_mask, nonpage_lower_bits_mask, nonpage_upper_bits_mask}; }
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
            ...
            exponential_pauli_cz_coeff_tp_cl(
...
# else // BOOST_NO_CXX14_GENERIC_LAMBDAS
              return ::ket::mpi::gate::page::detail::one_page_qubit_gate<1u>(
                parallel_policy, local_state, permutated_target_qubit,
                ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::make_do_exponential_pauli_cz_coeff_tp_cl(
                  phase_coefficient, conj_phase_coefficient,
                  permutated_control_qubit_mask, nonpage_lower_bits_mask, nonpage_upper_bits_mask));
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
            }
            ...
            exponential_pauli_cz_coeff_tp_cu(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"exponential_pauli_cz_coeff_tp_cu"}; }
...
# ifdef BOOST_NO_CXX14_GENERIC_LAMBDAS
            ...
            struct do_exponential_pauli_cz_coeff_tp_cg
            {
              Complex const* phase_coefficient_ptr_;
              Complex const* conj_phase_coefficient_ptr_;

              explicit do_exponential_pauli_cz_coeff_tp_cg(
            ...
            }; // struct do_exponential_pauli_cz_coeff_tp_cg<Complex>

            template <typename Complex>
            inline ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::do_exponential_pauli_cz_coeff_tp_cg<Complex>
            make_do_exponential_pauli_cz_coeff_tp_cg(Complex const& phase_coefficient, Complex const& conj_phase_coefficient)
            { return ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::do_exponential_pauli_cz_coeff_tp_cg<Complex>{phase_coefficient, conj_phase_coefficient}; }
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
            ...
            template <
              ...
              typename Complex, typename Allocator, typename StateInteger, typename BitInteger>
            inline ::ket::mpi::state<Complex, true, Allocator>&
            exponential_pauli_cz_coeff_tp_cg(
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              Complex const& phase_coefficient,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
...
# else // BOOST_NO_CXX14_GENERIC_LAMBDAS
              return ::ket::mpi::gate::page::detail::one_page_qubit_gate<0u>(
                parallel_policy, local_state, permutated_target_qubit,
                ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::make_do_exponential_pauli_cz_coeff_tp_cg(
                  phase_coefficient, conj_phase_coefficient));
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
            }
          } // namespace exponential_pauli_cz_coeff_tp_detail
          ...
          [[noreturn]] inline RandomAccessRange& exponential_pauli_cz_coeff_tp(
            ...
            yampi::rank const)
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"exponential_pauli_cz_coeff_tp"}; }
            ...
            yampi::rank const rank)
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::exponential_pauli_cz_coeff_tp_cl(
                parallel_policy, local_state, phase_coefficient, permutated_target_qubit, permutated_control_qubit);

            return ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::exponential_pauli_cz_coeff_tp_cg(
              parallel_policy,
            ...
            yampi::rank const rank)
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::exponential_pauli_cz_coeff_tp_detail::exponential_pauli_cz_coeff_tp_cu(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_EXPONENTIAL_PAULI_CZ_TP_DIAGONAL_HPP
