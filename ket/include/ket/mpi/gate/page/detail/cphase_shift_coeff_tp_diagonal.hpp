        ...
        namespace detail
        {
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::cphase_shift_coeff_tp_detail::cphase_shift_coeff_tp_cl(
                parallel_policy, local_state, phase_coefficient, permutated_target_qubit, permutated_control_qubit);

            return ::ket::mpi::gate::page::detail::cphase_shift_coeff_tp_detail::cphase_shift_coeff_tp_cg(
              parallel_policy,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::cphase_shift_coeff_tp_detail::cphase_shift_coeff_tp_cu(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_CPHASE_SHIFT_COEFF_TP_DIAGONAL_HPP
