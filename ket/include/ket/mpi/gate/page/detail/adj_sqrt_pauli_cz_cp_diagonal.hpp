#ifndef KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_CP_DIAGONAL_HPP
# define KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_CP_DIAGONAL_HPP
  ...
  namespace mpi
  {
    namespace gate
    {
      namespace page
      {
        namespace detail
        {
          namespace adj_sqrt_pauli_cz_cp_detail
          {
            ...
            inline auto adj_sqrt_pauli_cz_cp_tl(
            ...
            [[noreturn]] inline auto adj_sqrt_pauli_cz_cp_tu(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"adj_sqrt_pauli_cz_cp_tu"}; }

            template <
              typename StateInteger, typename BitInteger, typename NumProcesses,
              typename ParallelPolicy, typename Complex, typename Allocator>
            inline auto adj_sqrt_pauli_cz_cp_tu(
              ::ket::mpi::utility::policy::unit_mpi<StateInteger, BitInteger, NumProcesses> const& mpi_policy,
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
            ...
            template <
              typename ParallelPolicy,
              typename Complex, typename Allocator, typename StateInteger, typename BitInteger>
            inline auto adj_sqrt_pauli_cz_cp_tg(
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
              ::ket::mpi::permutated< ::ket::control< ::ket::qubit<StateInteger, BitInteger> > > const permutated_control_qubit,
          ...
          [[noreturn]] inline auto adj_sqrt_pauli_cz_cp(
            ...
            yampi::rank const)
          -> RandomAccessRange&
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"adj_sqrt_pauli_cz_cp"}; }
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_target_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_cp_detail::adj_sqrt_pauli_cz_cp_tl(
                parallel_policy, local_state, permutated_target_qubit, permutated_control_qubit);

            return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_cp_detail::adj_sqrt_pauli_cz_cp_tg(
              parallel_policy,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_target_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_cp_detail::adj_sqrt_pauli_cz_cp_tu(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_CP_DIAGONAL_HPP
