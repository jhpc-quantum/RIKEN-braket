#ifndef KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_P_DIAGONAL_HPP
# define KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_P_DIAGONAL_HPP
      ...
      namespace page
      {
        namespace detail
        {
          namespace adj_sqrt_pauli_cz_p_detail
          {
            ...
            [[noreturn]] inline auto adj_sqrt_pauli_cz_p_u(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"adj_sqrt_pauli_cz_p_cu"}; }

            template <
              typename StateInteger, typename BitInteger, typename NumProcesses,
              typename ParallelPolicy, typename Complex, typename Allocator>
            inline auto adj_sqrt_pauli_cz_p_u(
              ::ket::mpi::utility::policy::unit_mpi<StateInteger, BitInteger, NumProcesses> const& mpi_policy,
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::control< ::ket::qubit<StateInteger, BitInteger> > > const page_permutated_control_qubit,
            ...
            template <
              typename ParallelPolicy,
              typename Complex, typename Allocator, typename StateInteger, typename BitInteger>
            inline auto adj_sqrt_pauli_cz_p_g(
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::control< ::ket::qubit<StateInteger, BitInteger> > > const page_permutated_control_qubit,
              ::ket::mpi::permutated< ::ket::control< ::ket::qubit<StateInteger, BitInteger> > > const nonpage_permutated_control_qubit,
          ...
          [[noreturn]] inline auto adj_sqrt_pauli_cz_p(
            ...
            yampi::rank const)
          -> RandomAccessRange&
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"adj_sqrt_pauli_cz_p"}; }
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_p_detail::adj_sqrt_pauli_cz_p_l(
                parallel_policy, local_state, page_permutated_control_qubit, nonpage_permutated_control_qubit);

            return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_p_detail::adj_sqrt_pauli_cz_p_g(
              parallel_policy,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (nonpage_permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_p_detail::adj_sqrt_pauli_cz_p_u(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_ADJ_SQRT_PAULI_CZ_P_DIAGONAL_HPP
