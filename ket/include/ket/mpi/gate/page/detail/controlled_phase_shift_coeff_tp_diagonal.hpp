      ...
      namespace page
      {
        namespace detail
        {
          namespace controlled_phase_shift_coeff_tp_detail
          {
            ...
            [[deprecated]] inline auto controlled_phase_shift_coeff_tp_cl(
            ...
            [[deprecated, noreturn]] inline auto controlled_phase_shift_coeff_tp_cu(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"controlled_phase_shift_coeff_tp_cu"}; }

            template <
              typename StateInteger, typename BitInteger, typename NumProcesses,
              typename ParallelPolicy, typename Complex, typename Allocator>
            [[deprecated]] inline auto controlled_phase_shift_coeff_tp_cu(
              ::ket::mpi::utility::policy::unit_mpi<StateInteger, BitInteger, NumProcesses> const& mpi_policy,
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              Complex const& phase_coefficient,
            ...
            template <
              typename ParallelPolicy,
              typename Complex, typename Allocator, typename StateInteger, typename BitInteger>
            [[deprecated]] inline auto controlled_phase_shift_coeff_tp_cg(
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              Complex const& phase_coefficient,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
          ...
          [[deprecated, noreturn]] inline auto controlled_phase_shift_coeff_tp(
            ...
            yampi::rank const)
          -> RandomAccessRange&
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"controlled_phase_shift_coeff_tp"}; }
