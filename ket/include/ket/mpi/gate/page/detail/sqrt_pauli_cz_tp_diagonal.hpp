#ifndef KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_CZ_TP_DIAGONAL_HPP
# define KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_CZ_TP_DIAGONAL_HPP
  ...
  namespace mpi
  {
    namespace gate
    {
      namespace page
      {
        namespace detail
        {
          namespace sqrt_pauli_cz_tp_detail
          {
            ...
            inline auto sqrt_pauli_cz_tp_cl(
            ...
            [[noreturn]] inline auto sqrt_pauli_cz_tp_cu(
            ...
            { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"sqrt_pauli_cz_tp_cu"}; }

            template <
              typename StateInteger, typename BitInteger, typename NumProcesses,
              typename ParallelPolicy, typename Complex, typename Allocator>
            inline auto sqrt_pauli_cz_tp_cu(
              ::ket::mpi::utility::policy::unit_mpi<StateInteger, BitInteger, NumProcesses> const& mpi_policy,
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
            ...
            template <
              typename ParallelPolicy,
              typename Complex, typename Allocator, typename StateInteger, typename BitInteger>
            inline auto sqrt_pauli_cz_tp_cg(
              ParallelPolicy const parallel_policy,
              ::ket::mpi::state<Complex, true, Allocator>& local_state,
              ::ket::mpi::permutated< ::ket::qubit<StateInteger, BitInteger> > const permutated_target_qubit,
              ::ket::mpi::permutated< ::ket::control< ::ket::qubit<StateInteger, BitInteger> > > const permutated_control_qubit,
          ...
          [[noreturn]] inline auto sqrt_pauli_cz_tp(
            ...
            yampi::rank const)
          -> RandomAccessRange&
          { throw ::ket::mpi::gate::page::unsupported_page_gate_operation{"sqrt_pauli_cz_tp"}; }
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::sqrt_pauli_cz_tp_detail::sqrt_pauli_cz_tp_cl(
                parallel_policy, local_state, permutated_target_qubit, permutated_control_qubit);

            return ::ket::mpi::gate::page::detail::sqrt_pauli_cz_tp_detail::sqrt_pauli_cz_tp_cg(
              parallel_policy,
          ...
          -> ::ket::mpi::state<Complex, true, Allocator>&
          {
            ...
            if (permutated_control_qubit < least_permutated_global_qubit)
              return ::ket::mpi::gate::page::detail::sqrt_pauli_cz_tp_detail::sqrt_pauli_cz_tp_cu(
...
#endif // KET_MPI_GATE_PAGE_DETAIL_SQRT_PAULI_CZ_TP_DIAGONAL_HPP
