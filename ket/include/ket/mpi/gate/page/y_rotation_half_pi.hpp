  ...
  namespace mpi
  {
    namespace gate
    {
      namespace page
      {
        ...
        inline ::ket::mpi::state<Complex, 0, StateAllocator>& y_rotation_half_pi(
...
# ifdef BOOST_NO_CXX11_LAMBDAS
          ...
          struct y_rotation_half_pi_loop_inside
          {
            RandomAccessIterator zero_first_;
            RandomAccessIterator one_first_;

            y_rotation_half_pi_loop_inside(
          ...
          template <typename RandomAccessIterator>
          inline y_rotation_half_pi_loop_inside<RandomAccessIterator>
          make_y_rotation_half_pi_loop_inside(
            RandomAccessIterator const zero_first,
            RandomAccessIterator const one_first)
          {
            typedef
              ::ket::mpi::gate::page::y_rotation_half_pi_detail::y_rotation_half_pi_loop_inside<RandomAccessIterator>
              result_type;
...
# endif // BOOST_NO_CXX11_LAMBDAS
        ...
        template <
          ...
          typename StateInteger, typename BitInteger, typename PermutationAllocator>
        inline ::ket::mpi::state<Complex, num_page_qubits_, StateAllocator>& y_rotation_half_pi(
...
# else // BOOST_NO_CXX11_LAMBDAS
            loop_n(
              parallel_policy,
              boost::size(zero_page_range),
              ::ket::mpi::gate::page::y_rotation_half_pi_detail::make_y_rotation_half_pi_loop_inside(
...
# endif // BOOST_NO_CXX11_LAMBDAS
        ...
        template <
          ...
          typename Complex, typename StateAllocator,
          typename StateInteger, typename BitInteger, typename PermutationAllocator>
        inline ::ket::mpi::state<Complex, 0, StateAllocator>& adj_y_rotation_half_pi(
          ::ket::mpi::utility::policy::general_mpi const, ParallelPolicy const,
          ::ket::mpi::state<Complex, 0, StateAllocator>& local_state,
          ::ket::qubit<StateInteger, BitInteger> const,
          ::ket::mpi::qubit_permutation<
...
# ifdef BOOST_NO_CXX11_LAMBDAS
          template <typename RandomAccessIterator>
          struct adj_y_rotation_half_pi_loop_inside
          {
            RandomAccessIterator zero_first_;
            RandomAccessIterator one_first_;

            adj_y_rotation_half_pi_loop_inside(
              RandomAccessIterator const zero_first,
              RandomAccessIterator const one_first)
              : zero_first_(zero_first), one_first_(one_first)
            { }
          ...
          template <typename RandomAccessIterator>
          inline adj_y_rotation_half_pi_loop_inside<RandomAccessIterator>
          make_adj_y_rotation_half_pi_loop_inside(
            RandomAccessIterator const zero_first,
            RandomAccessIterator const one_first)
          {
            typedef
              ::ket::mpi::gate::page::y_rotation_half_pi_detail::adj_y_rotation_half_pi_loop_inside<RandomAccessIterator>
              result_type;
...
# endif // BOOST_NO_CXX11_LAMBDAS
        ...
        template <
          ...
          typename Complex, int num_page_qubits_, typename StateAllocator,
          typename StateInteger, typename BitInteger, typename PermutationAllocator>
        inline ::ket::mpi::state<Complex, num_page_qubits_, StateAllocator>& adj_y_rotation_half_pi(
          ::ket::mpi::utility::policy::general_mpi const,
          ParallelPolicy const parallel_policy,
          ::ket::mpi::state<Complex, num_page_qubits_, StateAllocator>& local_state,
          ::ket::qubit<StateInteger, BitInteger> const qubit,
...
# else // BOOST_NO_CXX11_LAMBDAS
            loop_n(
              parallel_policy,
              boost::size(zero_page_range),
              ::ket::mpi::gate::page::y_rotation_half_pi_detail::make_adj_y_rotation_half_pi_loop_inside(
                boost::begin(zero_page_range), boost::begin(one_page_range)));
# endif // BOOST_NO_CXX11_LAMBDAS
          }
