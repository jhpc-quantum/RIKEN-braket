...
# include <ket/mpi/gate/page/detail/sqrt_pauli_cz_p_diagonal.hpp>
...
# include <ket/mpi/gate/page/detail/adj_sqrt_pauli_cz_p_diagonal.hpp>
  ...
  namespace mpi
  {
    namespace gate
    {
      namespace page
      {
        ...
        // cz_p: only one control qubit of CsZ is on page
        // CsZ_{cc'} or C1sZ_{cc'}
        // CsZ_{1,2} (a_{00} |00> + a_{01} |01> + a_{10} |10> + a_{11} |11>)
        //   = a_{00} |00> + a_{01} |01> + a_{10} |10> + i a_{11} |11>
        template <
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::page::detail::sqrt_pauli_cz_p(
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::page::detail::adj_sqrt_pauli_cz_p(
            mpi_policy, parallel_policy, local_state,
            page_permutated_control_qubit, nonpage_permutated_control_qubit, rank);
        }
