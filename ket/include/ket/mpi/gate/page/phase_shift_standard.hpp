#ifndef KET_MPI_GATE_PAGE_PHASE_SHIFT_STANDARD_HPP
# define KET_MPI_GATE_PAGE_PHASE_SHIFT_STANDARD_HPP
...
# ifdef BOOST_NO_CXX14_GENERIC_LAMBDAS
          ...
          }; // struct cphase_shift_coeff_tp<Complex, StateInteger>

          template <typename Complex, typename StateInteger>
          inline ::ket::mpi::gate::page::phase_shift_detail::cphase_shift_coeff_tp<Complex, StateInteger>
          make_cphase_shift_coeff_tp(
            Complex const& phase_coefficient,
            StateInteger const control_qubit_mask,
            StateInteger const nonpage_lower_bits_mask,
...
# else // BOOST_NO_CXX14_GENERIC_LAMBDAS
          return ::ket::mpi::gate::page::detail::one_page_qubit_gate<1u>(
            parallel_policy, local_state, permutated_target_qubit,
            ::ket::mpi::gate::page::phase_shift_detail::make_cphase_shift_coeff_tp(
              phase_coefficient, control_qubit_mask, nonpage_lower_bits_mask, nonpage_upper_bits_mask));
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
        }
...
# ifdef BOOST_NO_CXX14_GENERIC_LAMBDAS
          ...
          }; // struct cphase_shift_coeff_cp<Complex, StateInteger>

          template <typename Complex, typename StateInteger>
          inline ::ket::mpi::gate::page::phase_shift_detail::cphase_shift_coeff_cp<Complex, StateInteger>
          make_cphase_shift_coeff_cp(
            Complex const& phase_coefficient,
            StateInteger const target_qubit_mask,
            StateInteger const nonpage_lower_bits_mask,
            StateInteger const nonpage_upper_bits_mask)
...
# else // BOOST_NO_CXX14_GENERIC_LAMBDAS
          return ::ket::mpi::gate::page::detail::one_page_qubit_gate<1u>(
            parallel_policy, local_state, permutated_control_qubit,
            ::ket::mpi::gate::page::phase_shift_detail::make_cphase_shift_coeff_cp(
              phase_coefficient, target_qubit_mask, nonpage_lower_bits_mask, nonpage_upper_bits_mask));
# endif // BOOST_NO_CXX14_GENERIC_LAMBDAS
        }
...
#endif // KET_MPI_GATE_PAGE_PHASE_SHIFT_STANDARD_HPP
