      ...
      namespace local
      {
        ...
        -> RandomAccessRange&
        {
          ...
          if (::ket::mpi::page::any_on_page(local_state, permutation[qubit1], permutation[qubit2], permutation[qubit3], permutation[qubits]...))
          {
            ...
            ::ket::mpi::gate::local::dispatch::transpage_pauli_x<local_state_type>::call(
      ...
      namespace runtime
      {
        namespace local
        {
          ...
          -> RandomAccessRange&
          {
            ...
            {
              using local_state_type = std::remove_const_t<std::remove_reference_t<RandomAccessRange>>;
              return ::ket::mpi::gate::runtime::local::dispatch::transpage_pauli_x<local_state_type>::call(
        ...
        namespace pauli_x_detail
        {
          ...
          -> RandomAccessRange&
          {
            ...
            return ::ket::mpi::gate::runtime::local::pauli_x(
              mpi_policy, parallel_policy,
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string(num_control_qubits, 'C').append(num_target_qubits, 'X').append(" ")),
                target_qubits, control_qubits),
              environment};

            return ::ket::mpi::gate::runtime::pauli_x_detail::pauli_x(
              mpi_policy, parallel_policy,
              local_state, permutation, buffer, communicator, environment,
              target_qubits, control_qubits);
          }
        ...
        namespace ranges
        {
          ...
          -> RandomAccessRange&
          {
            ...
            ::ket::mpi::utility::log_with_time_guard<char> print{
              ::ket::mpi::gate::detail::runtime::append_qubits_string(
                ::ket::mpi::utility::generate_logger_string(
                  std::string{"Adj("}.append(num_control_qubits, 'C').append(num_target_qubits, 'X').append(") ")),
                target_qubits, control_qubits),
              environment};
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::pauli_x(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
        ...
        -> RandomAccessRange&
        {
          return ::ket::mpi::gate::runtime::adj_pauli_x(
            ::ket::mpi::utility::policy::make_simple_mpi(), parallel_policy,
            local_state, permutation, buffer, std::forward<Args>(args)...);
        }
