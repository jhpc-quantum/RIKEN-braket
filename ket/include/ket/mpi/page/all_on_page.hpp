  ...
  namespace mpi
  {
    namespace page
    {
      namespace runtime
      {
        ...
        -> bool
        {
          if (not ::ket::mpi::page::is_on_page(permutated_target_qubit, local_state))
            return false;

          return ::ket::mpi::page::runtime::all_on_page(local_state, permutated_control_qubit_first, permutated_control_qubit_last);
        }
        ...
        -> bool
        {
          return ::ket::mpi::page::runtime::all_on_page(local_state, permutated_target_qubit_first, permutated_target_qubit_last)
            and ::ket::mpi::page::runtime::all_on_page(local_state, permutated_control_qubit_first, permutated_control_qubit_last);
        }

        namespace ranges
        {
          template <typename LocalState, typename PermutatedQubits>
          inline auto all_on_page(LocalState const& local_state, PermutatedQubits const& permutated_qubits)
          -> bool
          {
            using std::begin;
            using std::end;
            return ::ket::mpi::page::runtime::all_on_page(local_state, begin(permutated_qubits), end(permutated_qubits));
          }
          ...
          -> bool
          {
            using std::begin;
            using std::end;
            return ::ket::mpi::page::runtime::all_on_page(
