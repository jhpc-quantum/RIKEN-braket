...
# ifdef BOOST_NO_CXX11_LAMBDAS
        ...
        struct spin_expectation_value_loop_inside
        {
          ...
          spin_expectation_value_loop_inside(
            ...
            : zero_first_(zero_first), one_first_(one_first), spins_in_threads_(spins_in_threads)
          { }
        ...
        struct spin_expectation_value_accumulate_inside
        {
          ...
          Spin operator()(Spin accumulated_spin, Spin const& spin_in_thread) const
          {
...
# ifndef BOOST_NO_CXX11_LAMBDAS
          loop_n(
            ...
            [&zero_page_range, &one_page_range, &spins_in_threads](StateInteger const index, int const thread_index)
            {
...
# ifndef BOOST_NO_CXX11_LAMBDAS
        spin_type spin
          = boost::accumulate(
              ...
              [](spin_type accumulated_spin, spin_type const& spin_in_thread)
              {
                accumulated_spin[0u] += spin_in_thread[0u];
                accumulated_spin[1u] += spin_in_thread[1u];
                accumulated_spin[2u] += spin_in_thread[2u];
