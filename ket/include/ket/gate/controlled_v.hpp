          ...
          auto const iter0
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  index_wo_qubits, index0, unsorted_qubits, sorted_qubits_with_sentinel);
          auto const iter1
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  index_wo_qubits, index1, unsorted_qubits, sorted_qubits_with_sentinel);
    ...
    namespace runtime
    {
      ...
      namespace qubit_ranges
      {
        ...
        -> void
        {
          ...
          static_assert(
            std::is_same<control_qubit_type, ::ket::utility::meta::range_value_t<ControlQubits>>::value,
            "The value_type of ControlQubits should be ket::control<ket::qubit<S, B>>");
...
# ifndef KET_USE_BIT_MASKS_EXPLICITLY
          ::ket::gate::runtime::nocache::qubit_ranges::gate(
            parallel_policy, first, last,
            [num_control_qubits, &one_plus_phase_coefficient, &one_minus_phase_coefficient](
              auto const first, StateInteger const index_wo_qubits,
...
# endif // KET_USE_BIT_MASKS_EXPLICITLY
        ...
        -> void
        {
          ::ket::gate::runtime::qubit_ranges::controlled_v_coeff(
            ::ket::utility::policy::make_sequential(), first, last, phase_coefficient, target_qubit, control_qubits);
        }
      } // namespace qubit_ranges
      ...
      namespace ranges
      {
        ...
        -> RandomAccessRange&
        {
          ...
          using std::end;
          ::ket::gate::runtime::qubit_ranges::controlled_v_coeff(
            begin(state), end(state), phase_coefficient, target_qubit, control_qubits);
          return state;
        }
      } // namespace ranges
      ...
      namespace qubit_ranges
      {
        ...
        -> void
        {
          using std::conj;
          ::ket::gate::runtime::qubit_ranges::controlled_v_coeff(
            first, last, conj(phase_coefficient), target_qubit, control_qubits);
        }
      } // namespace qubit_ranges
      ...
      {
        using std::conj;
        ::ket::gate::runtime::controlled_v_coeff(
      ...
      namespace ranges
      {
        ...
        {
          using std::conj;
          return ::ket::gate::runtime::ranges::controlled_v_coeff(
        ...
        {
          using std::conj;
          return ::ket::gate::runtime::ranges::controlled_v_coeff(state, conj(phase_coefficient), target_qubit, control_qubits);
        }
      } // namespace ranges
      ...
      namespace qubit_ranges
      {
        ...
        inline auto adj_controlled_v(
          ...
          ControlQubits const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::controlled_v(parallel_policy, first, last, -phase, target_qubit, control_qubits); }
        ...
        inline auto adj_controlled_v(
          ...
          ControlQubits const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::controlled_v(first, last, -phase, target_qubit, control_qubits); }
      } // namespace qubit_ranges
      ...
      inline auto adj_controlled_v(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::controlled_v(parallel_policy, first, last, -phase, target_qubit, control_qubit_first, control_qubit_last); }
      ...
      inline auto adj_controlled_v(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::controlled_v(first, last, -phase, target_qubit, control_qubit_first, control_qubit_last); }
      ...
      namespace ranges
      {
        ...
        inline auto adj_controlled_v(
          ...
          ControlQubits const& control_qubits)
        -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
        { return ::ket::gate::runtime::ranges::controlled_v(parallel_policy, state, -phase, target_qubit, control_qubits); }
        ...
        inline auto adj_controlled_v(
          ...
          ControlQubits const& control_qubits)
        -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::controlled_v(state, -phase, target_qubit, control_qubits); }
      } // namespace ranges
    } // namespace runtime
  } // namespace gate
} // namespace ket
