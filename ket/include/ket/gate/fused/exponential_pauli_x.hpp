      ...
      namespace runtime
      {
        ...
        namespace ranges
        {
          ...
          -> void
          {
            ...
            ::ket::gate::fused::runtime::ranges::exponential_pauli_x_coeff(
        ...
        -> void
        {
          ::ket::gate::fused::runtime::ranges::adj_exponential_pauli_x_coeff(
            first, fused_index_wo_qubits,
            boost::make_iterator_range(unsorted_fused_qubit_first, unsorted_fused_qubit_last),
            boost::make_iterator_range(sorted_fused_qubit_with_sentinel_first, sorted_fused_qubit_with_sentinel_last),
            phase_coefficient,
        ...
        {
          using complex_type = typename std::iterator_traits<RandomAccessIterator>::value_type;
          ::ket::gate::fused::runtime::exponential_pauli_x_coeff(
            first, fused_index_wo_qubits,
        ...
        {
          using complex_type = typename std::iterator_traits<RandomAccessIterator>::value_type;
          ::ket::gate::fused::runtime::adj_exponential_pauli_x_coeff(
            first, fused_index_wo_qubits,
            unsorted_fused_qubit_first, unsorted_fused_qubit_last,
            sorted_fused_qubit_with_sentinel_first, sorted_fused_qubit_with_sentinel_last,
            ::ket::utility::exp_i<complex_type>(phase),
      ...
      -> void
      {
        ...
        for (auto index_wo_qubit = std::size_t{0u}; index_wo_qubit < count; ++index_wo_qubit)
        {
          ...
          auto const zero_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, zero_index, fused_qubit_masks, fused_index_masks);
          auto const one_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, one_index, fused_qubit_masks, fused_index_masks);
          auto const zero_iter_value = *zero_iter;
      ...
      -> void
      {
        ...
        for (auto index_wo_qubits = std::size_t{0u}; index_wo_qubits < count; ++index_wo_qubits)
        {
          ...
          auto const off_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, base_index, fused_qubit_masks, fused_index_masks);
          // xxx1_1xxx0_2xxx
          auto const qubit1_on_index = base_index bitor qubit1_mask;
          auto const qubit1_on_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, qubit1_on_index, fused_qubit_masks, fused_index_masks);
          // xxx0_1xxx1_2xxx
          auto const qubit2_on_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, base_index bitor qubit2_mask, fused_qubit_masks, fused_index_masks);
          // xxx1_1xxx1_2xxx
          auto const qubit12_on_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, qubit1_on_index bitor qubit2_mask, fused_qubit_masks, fused_index_masks);
      ...
      -> void
      {
        ...
        for (auto index_wo_qubits = std::size_t{0u}; index_wo_qubits < count; ++index_wo_qubits)
        {
          ...
          auto const control_on_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, control_on_index, fused_qubit_masks, fused_index_masks);
          auto const target_control_on_iter
            = first
              + ::ket::gate::utility::ranges::index_with_qubits(
                  fused_index_wo_qubits, target_control_on_index, fused_qubit_masks, fused_index_masks);
          auto const control_on_iter_value = *control_on_iter;
