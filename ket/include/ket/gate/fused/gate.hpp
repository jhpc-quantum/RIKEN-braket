...
#   endif // __cpp_constexpr >= 201603L
      ...
      namespace runtime
      {
        namespace ranges
        {
          ...
          template <typename ParallelPolicy, typename RandomAccessIterator, typename BitInteger, typename Function, typename QubitsRange>
          inline auto gate(
            ParallelPolicy const parallel_policy, int const thread_index,
            RandomAccessIterator const first, BitInteger const num_fused_qubits,
          ...
          -> void
          {
            ...
            ::ket::utility::loop_n_in_execute(
              ...
              [first, &function, &unsorted_operated_qubits, &sorted_operated_qubits_with_sentinel](
                state_integer_type const operated_index_wo_qubits, int const)
              {
                function(first, operated_index_wo_qubits, unsorted_operated_qubits, sorted_operated_qubits_with_sentinel);
              });
          }
      ...
      namespace runtime
      {
        namespace ranges
        {
          ...
          -> void
          {
            ...
            ::ket::utility::loop_n_in_execute(
              parallel_policy, count, thread_index,
              [first, &function, &operated_qubit_masks, &operated_index_masks](
                state_integer_type const operated_index_wo_qubits, int const)
              { function(first, operated_index_wo_qubits, operated_qubit_masks, operated_index_masks); });
          }
        } // namespace ranges
