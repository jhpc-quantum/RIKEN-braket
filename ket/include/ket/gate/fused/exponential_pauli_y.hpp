      ...
      namespace runtime
      {
        ...
        namespace ranges
        {
          ...
          -> void
          {
            ...
            std::array<control_qubit_type, 0u> const control_qubits{};
            ::ket::gate::fused::runtime::ranges::exponential_pauli_y_coeff(
              parallel_policy, thread_index, first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel,
              phase_coefficient, target_qubits, control_qubits);
          }
      ...
      namespace runtime
      {
        ...
        namespace ranges
        {
          ...
          -> void
          {
            using complex_type = typename std::iterator_traits<RandomAccessIterator>::value_type;
            ::ket::gate::fused::runtime::ranges::exponential_pauli_y_coeff(
              parallel_policy, thread_index, first, fused_index_wo_qubits, fused_qubit_masks, fused_index_masks,
              ::ket::utility::exp_i<complex_type>(phase), target_qubits, control_qubits);
          }
