...
# ifndef KET_USE_BIT_MASKS_EXPLICITLY
      ...
      -> void
      { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, control_qubit, control_qubits...); }
...
# else // KET_USE_BIT_MASKS_EXPLICITLY
      ...
      inline auto adj_pauli_z(
        ...
        ::ket::control< ::ket::qubit<StateInteger, BitInteger> > const control_qubit, ::ket::control<Qubits> const... control_qubits)
      -> void
      { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, fused_qubit_masks, fused_index_masks, control_qubit, control_qubits...); }
