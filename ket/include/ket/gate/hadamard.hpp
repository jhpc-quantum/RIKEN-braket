...
# endif // KET_USE_BIT_MASKS_EXPLICITLY
        ...
        inline auto hadamard(
          ...
          ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::hadamard(::ket::utility::policy::make_sequential(), first, last, target_qubit, control_qubits); }
        ...
        inline auto hadamard(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> void
        { ::ket::gate::runtime::qubit_ranges::hadamard(::ket::utility::policy::make_sequential(), first, last, target_qubit); }
      } // namespace qubit_ranges
      ...
      inline auto hadamard(
        ...
        ::ket::qubit<StateInteger, BitInteger> const target_qubit)
      -> void
      { ::ket::gate::runtime::qubit_ranges::hadamard(parallel_policy, first, last, target_qubit); }
      ...
      inline auto hadamard(
        ...
        ::ket::qubit<StateInteger, BitInteger> const target_qubit)
      -> void
      { ::ket::gate::runtime::qubit_ranges::hadamard(first, last, target_qubit); }
      ...
      namespace ranges
      {
        ...
        -> RandomAccessRange&
        {
          using std::begin;
          using std::end;
          ::ket::gate::runtime::qubit_ranges::hadamard(parallel_policy, begin(state), end(state), target_qubit, control_qubits);
          return state;
        }
        ...
        -> RandomAccessRange&
        {
          using std::begin;
          using std::end;
          ::ket::gate::runtime::qubit_ranges::hadamard(parallel_policy, begin(state), end(state), target_qubit);
          return state;
        }
        ...
        -> RandomAccessRange&
        {
          using std::begin;
          using std::end;
          ::ket::gate::runtime::qubit_ranges::hadamard(begin(state), end(state), target_qubit, control_qubits);
          return state;
        }

        template <typename RandomAccessRange, typename StateInteger, typename BitInteger>
        inline auto hadamard(RandomAccessRange& state, ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        {
          using std::begin;
          using std::end;
          ::ket::gate::runtime::qubit_ranges::hadamard(begin(state), end(state), target_qubit);
          return state;
        }
      } // namespace ranges
      ...
      namespace qubit_ranges
      {
        ...
        inline auto adj_hadamard(
          ...
          ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::hadamard(parallel_policy, first, last, target_qubit, control_qubits); }
        ...
        inline auto adj_hadamard(
          ...
          ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::hadamard(first, last, target_qubit, control_qubits); }
      ...
      inline auto adj_hadamard(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::hadamard(parallel_policy, first, last, target_qubit, control_qubit_first, control_qubit_last); }
      ...
      inline auto adj_hadamard(
        ...
        ::ket::qubit<StateInteger, BitInteger> const target_qubit)
      -> void
      { ::ket::gate::runtime::hadamard(parallel_policy, first, last, target_qubit); }
      ...
      inline auto adj_hadamard(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::hadamard(first, last, target_qubit, control_qubit_first, control_qubit_last); }
      ...
      inline auto adj_hadamard(
        ...
        ::ket::qubit<StateInteger, BitInteger> const target_qubit)
      -> void
      { ::ket::gate::runtime::hadamard(first, last, target_qubit); }
      ...
      namespace ranges
      {
        ...
        inline auto adj_hadamard(
          ...
          ControlQubitsRange const& control_qubits)
        -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::hadamard(parallel_policy, state, target_qubit, control_qubits); }
        ...
        inline auto adj_hadamard(
          ...
          ::ket::qubit<StateInteger, BitInteger> const target_qubit)
        -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::hadamard(parallel_policy, state, target_qubit); }

        template <typename RandomAccessRange, typename StateInteger, typename BitInteger, typename ControlQubitsRange>
        inline auto adj_hadamard(
          RandomAccessRange& state, ::ket::qubit<StateInteger, BitInteger> const target_qubit, ControlQubitsRange const& control_qubits)
        -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::hadamard(state, target_qubit, control_qubits); }

        template <typename RandomAccessRange, typename StateInteger, typename BitInteger>
        inline auto adj_hadamard( RandomAccessRange& state, ::ket::qubit<StateInteger, BitInteger> const target_qubit) -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::hadamard(state, target_qubit); }
      } // namespace ranges
    } // namespace runtime
  } // namespace gate
} // namespace ket
