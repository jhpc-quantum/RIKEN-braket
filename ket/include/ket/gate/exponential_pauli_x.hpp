            ...
            auto iter2
              = first
                + ::ket::gate::utility::ranges::index_with_qubits(
                    index_wo_qubits, base_index + (num_target_indices - std::size_t{1u} - i), unsorted_qubits, sorted_qubits_with_sentinel);
          ...
          int const)
        {
          ...
          for (auto i = std::size_t{0u}; i < half_num_target_indices; ++i)
          {
            ...
            auto iter2
              = first
                + ::ket::gate::utility::ranges::index_with_qubits(
                    index_wo_qubits, base_index + (num_target_indices - std::size_t{1u} - i), qubit_masks, index_masks);
            auto const value1 = *iter1;
...
# endif // KET_USE_BIT_MASKS_EXPLICITLY
    ...
    namespace ranges
    {
      ...
      -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
      {
        ...
        return ::ket::gate::ranges::exponential_pauli_x_coeff(parallel_policy, state, ::ket::utility::exp_i<complex_type>(phase), qubit, qubits...);
      }
...
# ifndef KET_USE_BIT_MASKS_EXPLICITLY
          ::ket::gate::runtime::nocache::qubit_ranges::gate(
            parallel_policy, first, last,
            [num_target_qubits, num_control_qubits, num_target_indices, half_num_target_indices, cos_theta, &i_sin_theta](
...
# endif // KET_USE_BIT_MASKS_EXPLICITLY
        ...
        -> void
        {
          ...
          ::ket::gate::runtime::qubit_ranges::exponential_pauli_x_coeff(
        ...
        inline auto exponential_pauli_x_coeff(
          ...
          QubitsRange const& target_qubits, ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x_coeff(::ket::utility::policy::make_sequential(), first, last, phase_coefficient, target_qubits, control_qubits); }
        ...
        inline auto exponential_pauli_x_coeff(
          ...
          QubitsRange const& target_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x_coeff(::ket::utility::policy::make_sequential(), first, last, phase_coefficient, target_qubits); }
      } // namespace qubit_ranges
      ...
      namespace qubit_ranges
      {
        ...
        -> void
        {
          using std::conj;
          ::ket::gate::runtime::qubit_ranges::exponential_pauli_x_coeff(
            first, last, conj(phase_coefficient), target_qubits, control_qubits);
        }
        ...
        {
          using std::conj;
          ::ket::gate::runtime::qubit_ranges::exponential_pauli_x_coeff(first, last, conj(phase_coefficient), target_qubits);
        }
      } // namespace qubit_ranges
      ...
      {
        using std::conj;
        ::ket::gate::runtime::exponential_pauli_x_coeff(
      ...
      namespace ranges
      {
        ...
        {
          using std::conj;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(
        ...
        {
          using std::conj;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(state, conj(phase_coefficient), target_qubits, control_qubits);
        }
        ...
        {
          using std::conj;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(state, conj(phase_coefficient), target_qubits);
        }
      } // namespace ranges
      ...
      -> void
      {
        ...
        ::ket::gate::runtime::exponential_pauli_x_coeff(
          ...
          qubit_first, qubit_last, control_qubit_first, control_qubit_last);
      }
      ...
      namespace ranges
      {
        ...
        -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
        {
          using complex_type = ::ket::utility::meta::range_value_t<RandomAccessRange>;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(
            parallel_policy, state, ::ket::utility::exp_i<complex_type>(phase), qubits, control_qubits);
        }
        ...
        -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
        {
          using complex_type = ::ket::utility::meta::range_value_t<RandomAccessRange>;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(
            parallel_policy, state, ::ket::utility::exp_i<complex_type>(phase), qubits);
        }
        ...
        -> std::enable_if_t< not ::ket::utility::policy::meta::is_loop_n_policy<std::remove_cv_t<std::remove_reference_t<RandomAccessRange>>>::value, RandomAccessRange& >
        {
          using complex_type = ::ket::utility::meta::range_value_t<RandomAccessRange>;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(
            state, ::ket::utility::exp_i<complex_type>(phase), qubits, control_qubits);
        }
        ...
        -> RandomAccessRange&
        {
          using complex_type = ::ket::utility::meta::range_value_t<RandomAccessRange>;
          return ::ket::gate::runtime::ranges::exponential_pauli_x_coeff(
            state, ::ket::utility::exp_i<complex_type>(phase), qubits);
        }
      } // namespace ranges
      ...
      namespace qubit_ranges
      {
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& target_qubits, ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x(parallel_policy, first, last, -phase, target_qubits, control_qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& target_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x(parallel_policy, first, last, -phase, target_qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& target_qubits, ControlQubitsRange const& control_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x(first, last, -phase, target_qubits, control_qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& target_qubits)
        -> void
        { ::ket::gate::runtime::qubit_ranges::exponential_pauli_x(first, last, -phase, target_qubits); }
      } // namespace qubit_ranges
      ...
      inline auto adj_exponential_pauli_x(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::exponential_pauli_x(parallel_policy, first, last, -phase, qubit_first, qubit_last, control_qubit_first, control_qubit_last); }
      ...
      inline auto adj_exponential_pauli_x(
        ...
        QubitIterator const qubit_first, QubitIterator const qubit_last)
      -> void
      { ::ket::gate::runtime::exponential_pauli_x(parallel_policy, first, last, -phase, qubit_first, qubit_last); }
      ...
      inline auto adj_exponential_pauli_x(
        ...
        ControlQubitIterator const control_qubit_first, ControlQubitIterator const control_qubit_last)
      -> void
      { ::ket::gate::runtime::exponential_pauli_x(first, last, -phase, qubit_first, qubit_last, control_qubit_first, control_qubit_last); }
      ...
      inline auto adj_exponential_pauli_x(
        ...
        QubitIterator const qubit_first, QubitIterator const qubit_last)
      -> void
      { ::ket::gate::runtime::exponential_pauli_x(first, last, -phase, qubit_first, qubit_last); }
      ...
      namespace ranges
      {
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& qubits, ControlQubitsRange const& control_qubits)
        -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
        { return ::ket::gate::runtime::ranges::exponential_pauli_x(parallel_policy, state, -phase, qubits, control_qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& qubits)
        -> std::enable_if_t< ::ket::utility::policy::meta::is_loop_n_policy<ParallelPolicy>::value, RandomAccessRange& >
        { return ::ket::gate::runtime::ranges::exponential_pauli_x(parallel_policy, state, -phase, qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& qubits, ControlQubitsRange const& control_qubits)
        -> std::enable_if_t< not ::ket::utility::policy::meta::is_loop_n_policy<std::remove_cv_t<std::remove_reference_t<RandomAccessRange>>>::value, RandomAccessRange& >
        { return ::ket::gate::runtime::ranges::exponential_pauli_x(state, -phase, qubits, control_qubits); }
        ...
        inline auto adj_exponential_pauli_x(
          ...
          QubitsRange const& qubits)
        -> RandomAccessRange&
        { return ::ket::gate::runtime::ranges::exponential_pauli_x(state, -phase, qubits); }
      } // namespace ranges
    } // namespace runtime
  } // namespace gate
} // namespace ket
