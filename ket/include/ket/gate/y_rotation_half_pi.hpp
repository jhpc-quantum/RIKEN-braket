  ...
  namespace gate
  {
    ...
    namespace ranges
    {
      ...
      inline RandomAccessRange& y_rotation_half_pi(
        ...
        ::ket::qubit<StateInteger, BitInteger> const qubit, ControlQubits const... control_qubits)
      {
        ::ket::gate::y_rotation_half_pi(parallel_policy, std::begin(state), std::end(state), qubit, control_qubits...);
        return state;
      }
    ...
    namespace ranges
    {
      ...
      inline RandomAccessRange& adj_y_rotation_half_pi(
        ...
        ::ket::qubit<StateInteger, BitInteger> const qubit, ControlQubits const... control_qubits)
      {
        ::ket::gate::adj_y_rotation_half_pi(parallel_policy, std::begin(state), std::end(state), qubit, control_qubits...);
        return state;
      }
