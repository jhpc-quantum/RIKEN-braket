...
# ifdef BOOST_NO_CXX11_LAMBDAS
      ...
      template <typename RandomAccessIterator, typename StateInteger>
      inline
      y_rotation_half_pi_loop_inside<RandomAccessIterator, StateInteger>
      make_y_rotation_half_pi_loop_inside(
        ...
        StateInteger const upper_bits_mask)
      {
        return y_rotation_half_pi_loop_inside<
...
# else // BOOST_NO_CXX11_LAMBDAS
        loop_n(
          parallel_policy,
          static_cast<StateInteger>(last-first)/2u,
          ::ket::gate::y_rotation_half_pi_detail::make_y_rotation_half_pi_loop_inside(
            first, qubit_mask, lower_bits_mask, upper_bits_mask));
# endif // BOOST_NO_CXX11_LAMBDAS
      }
    } // namespace y_rotation_half_pi_detail
...
# ifdef KET_PREFER_POINTER_TO_VECTOR_ITERATOR
      template <
        ...
        typename StateInteger, typename BitInteger>
      inline std::vector<Complex, Allocator>& y_rotation_half_pi(
...
# ifdef BOOST_NO_CXX11_LAMBDAS
      ...
      template <typename RandomAccessIterator, typename StateInteger>
      inline
      adj_y_rotation_half_pi_loop_inside<RandomAccessIterator, StateInteger>
      make_adj_y_rotation_half_pi_loop_inside(
        ...
        StateInteger const upper_bits_mask)
      {
        return adj_y_rotation_half_pi_loop_inside<
          RandomAccessIterator, StateInteger>(
            first, qubit_mask, lower_bits_mask, upper_bits_mask);
      }
# endif // BOOST_NO_CXX11_LAMBDAS
...
# else // BOOST_NO_CXX11_LAMBDAS
        loop_n(
          parallel_policy,
          static_cast<StateInteger>(last-first)/2u,
          ::ket::gate::y_rotation_half_pi_detail::make_adj_y_rotation_half_pi_loop_inside(
            first, qubit_mask, lower_bits_mask, upper_bits_mask));
# endif // BOOST_NO_CXX11_LAMBDAS
      }
    } // namespace y_rotation_half_pi_detail
...
# ifdef KET_PREFER_POINTER_TO_VECTOR_ITERATOR
      template <
        typename Complex, typename Allocator,
        typename StateInteger, typename BitInteger>
      inline std::vector<Complex, Allocator>& adj_y_rotation_half_pi(
        std::vector<Complex, Allocator>& state,
        ::ket::qubit<StateInteger, BitInteger> const qubit)
      {
        ::ket::gate::y_rotation_half_pi_detail::adj_y_rotation_half_pi_impl(
