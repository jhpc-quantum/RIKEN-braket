  ...
  namespace gate
  {
    ...
    namespace ranges
    {
      ...
      -> RandomAccessRange&
      {
        using std::begin;
        using std::end;
        ::ket::gate::controlled_phase_shift_coeff(parallel_policy, begin(state), end(state), phase_coefficient, control_qubit1, control_qubit2, control_qubits...);
        return state;
      }
      ...
      inline auto controlled_phase_shift_coeff(
        ...
        ::ket::control<Qubits> const... control_qubits)
      -> RandomAccessRange&
      { return ::ket::gate::ranges::controlled_phase_shift_coeff(::ket::utility::policy::make_sequential(), state, phase_coefficient, control_qubit1, control_qubit2, control_qubits...); }
    } // namespace ranges
    ...
    inline auto adj_controlled_phase_shift_coeff(
      ...
      ::ket::control<Qubits> const... control_qubits)
    -> void
    { using std::conj; ::ket::gate::controlled_phase_shift_coeff(parallel_policy, first, last, conj(phase_coefficient), control_qubit1, control_qubit2, control_qubits...); }
    ...
    inline auto adj_controlled_phase_shift_coeff(
      ...
      ::ket::control<Qubits> const... control_qubits)
    -> void
    { using std::conj; ::ket::gate::controlled_phase_shift_coeff(first, last, conj(phase_coefficient), control_qubit1, control_qubit2, control_qubits...); }
    ...
    namespace ranges
    {
      ...
      inline auto adj_controlled_phase_shift_coeff(
        ...
        ::ket::control<Qubits> const... control_qubits)
      -> RandomAccessRange&
      { using std::conj; return ::ket::gate::ranges::controlled_phase_shift_coeff(parallel_policy, state, conj(phase_coefficient), control_qubit1, control_qubit2, control_qubits...); }
      ...
      inline auto adj_controlled_phase_shift_coeff(
        ...
        ::ket::control<Qubits> const... control_qubits)
      -> RandomAccessRange&
      { using std::conj; return ::ket::gate::ranges::controlled_phase_shift_coeff(state, conj(phase_coefficient), control_qubit1, control_qubit2, control_qubits...); }
    } // namespace ranges
    ...
    -> void
    {
      ...
      ::ket::gate::controlled_phase_shift_coeff(parallel_policy, first, last, ::ket::utility::exp_i<complex_type>(phase), control_qubit1, control_qubit2, control_qubits...);
    }
    ...
    {
      using complex_type = typename std::iterator_traits<RandomAccessIterator>::value_type;
      ::ket::gate::controlled_phase_shift_coeff(first, last, ::ket::utility::exp_i<complex_type>(phase), control_qubit1, control_qubit2, control_qubits...);
    }
    ...
    namespace ranges
    {
      ...
      -> RandomAccessRange&
      {
        ...
        return ::ket::gate::ranges::controlled_phase_shift_coeff(parallel_policy, state, ::ket::utility::exp_i<complex_type>(phase), control_qubit1, control_qubit2, control_qubits...);
      }
      ...
      {
        using complex_type = ::ket::utility::meta::range_value_t<RandomAccessRange>;
        return ::ket::gate::ranges::controlled_phase_shift_coeff(state, ::ket::utility::exp_i<complex_type>(phase), control_qubit1, control_qubit2, control_qubits...);
      }
    } // namespace ranges
    ...
    inline auto adj_controlled_phase_shift(
      ...
      ::ket::control<Qubits> const... control_qubits)
    -> void
    { ::ket::gate::controlled_phase_shift(parallel_policy, first, last, -phase, control_qubit1, control_qubit2, control_qubits...); }
    ...
    inline auto adj_controlled_phase_shift(
      ...
      ::ket::control<Qubits> const... control_qubits)
    -> void
    { ::ket::gate::controlled_phase_shift(first, last, -phase, control_qubit1, control_qubit2, control_qubits...); }
    ...
    namespace ranges
    {
      ...
      inline auto adj_controlled_phase_shift(
        ...
        ::ket::control<Qubits> const... control_qubits)
      -> RandomAccessRange&
      { return ::ket::gate::ranges::controlled_phase_shift(parallel_policy, state, -phase, control_qubit1, control_qubit2, control_qubits...); }
      ...
      inline auto adj_controlled_phase_shift(
        ...
        ::ket::control<Qubits> const... control_qubits)
      -> RandomAccessRange&
      { return ::ket::gate::ranges::controlled_phase_shift(state, -phase, control_qubit1, control_qubit2, control_qubits...); }
    } // namespace ranges
