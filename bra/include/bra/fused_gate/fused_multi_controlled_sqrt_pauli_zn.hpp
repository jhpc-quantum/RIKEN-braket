#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_ZN_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_ZN_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_sqrt_pauli_zn final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_sqrt_pauli_zn(std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_sqrt_pauli_zn(std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_sqrt_pauli_zn(std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits);
      explicit fused_multi_controlled_sqrt_pauli_zn(std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_sqrt_pauli_zn() = default;
      fused_multi_controlled_sqrt_pauli_zn(fused_multi_controlled_sqrt_pauli_zn const&) = delete;
      fused_multi_controlled_sqrt_pauli_zn& operator=(fused_multi_controlled_sqrt_pauli_zn const&) = delete;
      fused_multi_controlled_sqrt_pauli_zn(fused_multi_controlled_sqrt_pauli_zn&&) = delete;
      fused_multi_controlled_sqrt_pauli_zn& operator=(fused_multi_controlled_sqrt_pauli_zn&&) = delete;
...
#   define CALL_SQRT_PAULI_Z(z, num_control_qubits, num_target_qubits) \
    ...
    auto call_sqrt_pauli_z_ ## num_target_qubits ## _ ## num_control_qubits(\
      Iterator const first, ::bra::state_integer_type const fused_index_wo_qubits,\
...
# undef DO_CALL_SQRT_PAULI_Z
# undef CALL_SQRT_PAULI_Z
...
# undef DO_CALL
    ...
    }; // class fused_multi_controlled_sqrt_pauli_zn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_ZN_HPP
