#ifndef BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_multi_controlled_sqrt_pauli_z(std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_sqrt_pauli_z(std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_adj_multi_controlled_sqrt_pauli_z() = default;
      fused_adj_multi_controlled_sqrt_pauli_z(fused_adj_multi_controlled_sqrt_pauli_z const&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_z& operator=(fused_adj_multi_controlled_sqrt_pauli_z const&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_z(fused_adj_multi_controlled_sqrt_pauli_z&&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_z& operator=(fused_adj_multi_controlled_sqrt_pauli_z&&) = delete;
...
#endif // BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
