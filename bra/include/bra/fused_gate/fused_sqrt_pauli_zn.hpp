#ifndef BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZN_HPP
# define BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZN_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_sqrt_pauli_zn final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_sqrt_pauli_zn(std::vector< ::bra::qubit_type > const& qubits);
      explicit fused_sqrt_pauli_zn(std::vector< ::bra::qubit_type >&& qubits);

      ~fused_sqrt_pauli_zn() = default;
      fused_sqrt_pauli_zn(fused_sqrt_pauli_zn const&) = delete;
      fused_sqrt_pauli_zn& operator=(fused_sqrt_pauli_zn const&) = delete;
      fused_sqrt_pauli_zn(fused_sqrt_pauli_zn&&) = delete;
      fused_sqrt_pauli_zn& operator=(fused_sqrt_pauli_zn&&) = delete;
...
# undef DO_CALL
    }; // class fused_sqrt_pauli_zn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZN_HPP
