#ifndef BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZZ_HPP
# define BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZZ_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_sqrt_pauli_zz final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_sqrt_pauli_zz(::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_sqrt_pauli_zz() = default;
      fused_sqrt_pauli_zz(fused_sqrt_pauli_zz const&) = delete;
      fused_sqrt_pauli_zz& operator=(fused_sqrt_pauli_zz const&) = delete;
      fused_sqrt_pauli_zz(fused_sqrt_pauli_zz&&) = delete;
      fused_sqrt_pauli_zz& operator=(fused_sqrt_pauli_zz&&) = delete;
...
#endif // BRA_FUSED_GATE_FUSED_SQRT_PAULI_ZZ_HPP
