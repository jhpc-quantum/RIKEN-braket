#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Z_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Z_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_z(::bra::real_type const phase, ::bra::qubit_type const qubit);

      ~fused_adj_exponential_pauli_z() = default;
      fused_adj_exponential_pauli_z(fused_adj_exponential_pauli_z const&) = delete;
      fused_adj_exponential_pauli_z& operator=(fused_adj_exponential_pauli_z const&) = delete;
      fused_adj_exponential_pauli_z(fused_adj_exponential_pauli_z&&) = delete;
      fused_adj_exponential_pauli_z& operator=(fused_adj_exponential_pauli_z&&) = delete;
...
# undef DO_CALL
      ...
      auto do_maybe_phase_shiftize_ez(
        typename std::vector< ::bra::qubit_type >::const_iterator const first,
        typename std::vector< ::bra::qubit_type >::const_iterator const last)
      -> boost::optional<std::pair< ::bra::control_qubit_type, ::bra::real_type >> override;
    }; // class fused_adj_exponential_pauli_z<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Z_HPP
