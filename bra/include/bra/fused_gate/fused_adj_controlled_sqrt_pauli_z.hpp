#ifndef BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_SQRT_PAULI_Z_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_SQRT_PAULI_Z_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_controlled_sqrt_pauli_z final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_controlled_sqrt_pauli_z(::bra::control_qubit_type const control_qubit1, ::bra::control_qubit_type const control_qubit2);

      ~fused_adj_controlled_sqrt_pauli_z() = default;
      fused_adj_controlled_sqrt_pauli_z(fused_adj_controlled_sqrt_pauli_z const&) = delete;
      fused_adj_controlled_sqrt_pauli_z& operator=(fused_adj_controlled_sqrt_pauli_z const&) = delete;
      fused_adj_controlled_sqrt_pauli_z(fused_adj_controlled_sqrt_pauli_z&&) = delete;
      fused_adj_controlled_sqrt_pauli_z& operator=(fused_adj_controlled_sqrt_pauli_z&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_adj_controlled_sqrt_pauli_z<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_SQRT_PAULI_Z_HPP
