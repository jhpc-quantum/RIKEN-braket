#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YY_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YY_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_pauli_yy final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_yy(::bra::real_type const phase, ::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_adj_exponential_pauli_yy() = default;
      fused_adj_exponential_pauli_yy(fused_adj_exponential_pauli_yy const&) = delete;
      fused_adj_exponential_pauli_yy& operator=(fused_adj_exponential_pauli_yy const&) = delete;
      fused_adj_exponential_pauli_yy(fused_adj_exponential_pauli_yy&&) = delete;
      fused_adj_exponential_pauli_yy& operator=(fused_adj_exponential_pauli_yy&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_pauli_yy<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YY_HPP
