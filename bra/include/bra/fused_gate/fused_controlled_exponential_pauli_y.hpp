#ifndef BRA_FUSED_GATE_FUSED_CONTROLLED_EXPONENTIAL_PAULI_Y_HPP
# define BRA_FUSED_GATE_FUSED_CONTROLLED_EXPONENTIAL_PAULI_Y_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_controlled_exponential_pauli_y final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_controlled_exponential_pauli_y(::bra::real_type const phase, ::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit);

      ~fused_controlled_exponential_pauli_y() = default;
      fused_controlled_exponential_pauli_y(fused_controlled_exponential_pauli_y const&) = delete;
      fused_controlled_exponential_pauli_y& operator=(fused_controlled_exponential_pauli_y const&) = delete;
      fused_controlled_exponential_pauli_y(fused_controlled_exponential_pauli_y&&) = delete;
      fused_controlled_exponential_pauli_y& operator=(fused_controlled_exponential_pauli_y&&) = delete;
...
# undef DO_CALL
    }; // class fused_controlled_exponential_pauli_y<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_CONTROLLED_EXPONENTIAL_PAULI_Y_HPP
