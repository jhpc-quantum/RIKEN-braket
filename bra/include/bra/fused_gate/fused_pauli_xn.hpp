#ifndef BRA_FUSED_GATE_FUSED_PAULI_XN_HPP
# define BRA_FUSED_GATE_FUSED_PAULI_XN_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_pauli_xn(std::vector< ::bra::qubit_type > const& qubits);
      explicit fused_pauli_xn(std::vector< ::bra::qubit_type >&& qubits);

      ~fused_pauli_xn() = default;
      fused_pauli_xn(fused_pauli_xn const&) = delete;
      fused_pauli_xn& operator=(fused_pauli_xn const&) = delete;
      fused_pauli_xn(fused_pauli_xn&&) = delete;
      fused_pauli_xn& operator=(fused_pauli_xn&&) = delete;
...
# undef DO_CALL
    }; // class fused_pauli_xn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PAULI_XN_HPP
