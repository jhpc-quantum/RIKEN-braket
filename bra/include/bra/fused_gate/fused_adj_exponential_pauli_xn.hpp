#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XN_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XN_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_pauli_xn final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_xn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& qubits);
      explicit fused_adj_exponential_pauli_xn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& qubits);

      ~fused_adj_exponential_pauli_xn() = default;
      fused_adj_exponential_pauli_xn(fused_adj_exponential_pauli_xn const&) = delete;
      fused_adj_exponential_pauli_xn& operator=(fused_adj_exponential_pauli_xn const&) = delete;
      fused_adj_exponential_pauli_xn(fused_adj_exponential_pauli_xn&&) = delete;
      fused_adj_exponential_pauli_xn& operator=(fused_adj_exponential_pauli_xn&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_pauli_xn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XN_HPP
