#ifndef BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_Z_HPP
# define BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_Z_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_exponential_pauli_z final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_exponential_pauli_z(::bra::real_type const phase, ::bra::qubit_type const qubit);

      ~fused_exponential_pauli_z() = default;
      fused_exponential_pauli_z(fused_exponential_pauli_z const&) = delete;
      fused_exponential_pauli_z& operator=(fused_exponential_pauli_z const&) = delete;
      fused_exponential_pauli_z(fused_exponential_pauli_z&&) = delete;
      fused_exponential_pauli_z& operator=(fused_exponential_pauli_z&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_exponential_pauli_z<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_Z_HPP
