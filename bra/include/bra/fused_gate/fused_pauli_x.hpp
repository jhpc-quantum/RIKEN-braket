#ifndef BRA_FUSED_GATE_FUSED_PAULI_X_HPP
# define BRA_FUSED_GATE_FUSED_PAULI_X_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_pauli_x(::bra::qubit_type const qubit);

      ~fused_pauli_x() = default;
      fused_pauli_x(fused_pauli_x const&) = delete;
      fused_pauli_x& operator=(fused_pauli_x const&) = delete;
      fused_pauli_x(fused_pauli_x&&) = delete;
      fused_pauli_x& operator=(fused_pauli_x&&) = delete;
...
# undef DO_CALL
    }; // class fused_pauli_x<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PAULI_X_HPP
