#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U1_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U1_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_u1 final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_u1(::bra::real_type const phase, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_u1(::bra::real_type const phase, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_u1() = default;
      fused_multi_controlled_u1(fused_multi_controlled_u1 const&) = delete;
      fused_multi_controlled_u1& operator=(fused_multi_controlled_u1 const&) = delete;
      fused_multi_controlled_u1(fused_multi_controlled_u1&&) = delete;
      fused_multi_controlled_u1& operator=(fused_multi_controlled_u1&&) = delete;
...
# undef DO_CALL
    }; // class fused_multi_controlled_u1<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U1_HPP
