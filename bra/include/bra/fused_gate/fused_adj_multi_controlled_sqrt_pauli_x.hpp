#ifndef BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_X_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_X_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_multi_controlled_sqrt_pauli_x final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_multi_controlled_sqrt_pauli_x(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_sqrt_pauli_x(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_adj_multi_controlled_sqrt_pauli_x() = default;
      fused_adj_multi_controlled_sqrt_pauli_x(fused_adj_multi_controlled_sqrt_pauli_x const&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_x& operator=(fused_adj_multi_controlled_sqrt_pauli_x const&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_x(fused_adj_multi_controlled_sqrt_pauli_x&&) = delete;
      fused_adj_multi_controlled_sqrt_pauli_x& operator=(fused_adj_multi_controlled_sqrt_pauli_x&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_multi_controlled_sqrt_pauli_x<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_SQRT_PAULI_X_HPP
