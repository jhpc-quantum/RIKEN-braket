#ifndef BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_SWAP_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_SWAP_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_multi_controlled_exponential_swap final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_adj_multi_controlled_exponential_swap() = default;
      fused_adj_multi_controlled_exponential_swap(fused_adj_multi_controlled_exponential_swap const&) = delete;
      fused_adj_multi_controlled_exponential_swap& operator=(fused_adj_multi_controlled_exponential_swap const&) = delete;
      fused_adj_multi_controlled_exponential_swap(fused_adj_multi_controlled_exponential_swap&&) = delete;
      fused_adj_multi_controlled_exponential_swap& operator=(fused_adj_multi_controlled_exponential_swap&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_adj_multi_controlled_exponential_swap<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_SWAP_HPP
