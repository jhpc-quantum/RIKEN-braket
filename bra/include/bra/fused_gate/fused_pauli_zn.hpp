#ifndef BRA_FUSED_GATE_FUSED_PAULI_ZN_HPP
# define BRA_FUSED_GATE_FUSED_PAULI_ZN_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_pauli_zn(std::vector< ::bra::qubit_type > const& qubits);
      explicit fused_pauli_zn(std::vector< ::bra::qubit_type >&& qubits);

      ~fused_pauli_zn() = default;
      fused_pauli_zn(fused_pauli_zn const&) = delete;
      fused_pauli_zn& operator=(fused_pauli_zn const&) = delete;
      fused_pauli_zn(fused_pauli_zn&&) = delete;
      fused_pauli_zn& operator=(fused_pauli_zn&&) = delete;
...
# undef DO_CALL
    }; // class fused_pauli_zn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PAULI_ZN_HPP
