#ifndef BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_X_HPP
# define BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_X_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_exponential_pauli_x final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_exponential_pauli_x(::bra::real_type const phase, ::bra::qubit_type const qubit);

      ~fused_exponential_pauli_x() = default;
      fused_exponential_pauli_x(fused_exponential_pauli_x const&) = delete;
      fused_exponential_pauli_x& operator=(fused_exponential_pauli_x const&) = delete;
      fused_exponential_pauli_x(fused_exponential_pauli_x&&) = delete;
      fused_exponential_pauli_x& operator=(fused_exponential_pauli_x&&) = delete;
...
# undef DO_CALL
    }; // class fused_exponential_pauli_x<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_EXPONENTIAL_PAULI_X_HPP
