#ifndef BRA_FUSED_GATE_FUSED_U3_HPP
# define BRA_FUSED_GATE_FUSED_U3_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const qubit);

      ~fused_u3() = default;
      fused_u3(fused_u3 const&) = delete;
      fused_u3& operator=(fused_u3 const&) = delete;
      fused_u3(fused_u3&&) = delete;
      fused_u3& operator=(fused_u3&&) = delete;
...
# undef DO_CALL
    }; // class fused_u3<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_U3_HPP
