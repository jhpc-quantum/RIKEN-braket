#ifndef BRA_FUSED_GATE_FUSED_ADJ_U2_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_U2_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_u2(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::qubit_type const qubit);

      ~fused_adj_u2() = default;
      fused_adj_u2(fused_adj_u2 const&) = delete;
      fused_adj_u2& operator=(fused_adj_u2 const&) = delete;
      fused_adj_u2(fused_adj_u2&&) = delete;
      fused_adj_u2& operator=(fused_adj_u2&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_u2<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_U2_HPP
