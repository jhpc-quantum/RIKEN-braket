#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_SWAP_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_SWAP_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_swap final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_adj_exponential_swap() = default;
      fused_adj_exponential_swap(fused_adj_exponential_swap const&) = delete;
      fused_adj_exponential_swap& operator=(fused_adj_exponential_swap const&) = delete;
      fused_adj_exponential_swap(fused_adj_exponential_swap&&) = delete;
      fused_adj_exponential_swap& operator=(fused_adj_exponential_swap&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_swap<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_SWAP_HPP
