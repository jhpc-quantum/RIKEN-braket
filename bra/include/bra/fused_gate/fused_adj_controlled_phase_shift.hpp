#ifndef BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_PHASE_SHIFT_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_PHASE_SHIFT_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_controlled_phase_shift final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      ...
      fused_adj_controlled_phase_shift& operator=(fused_adj_controlled_phase_shift const&) = delete;
      fused_adj_controlled_phase_shift(fused_adj_controlled_phase_shift&&) = delete;
      fused_adj_controlled_phase_shift& operator=(fused_adj_controlled_phase_shift&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_controlled_phase_shift<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_PHASE_SHIFT_HPP
