#ifndef BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_U3_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_U3_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_multi_controlled_u3 final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_multi_controlled_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_adj_multi_controlled_u3() = default;
      fused_adj_multi_controlled_u3(fused_adj_multi_controlled_u3 const&) = delete;
      fused_adj_multi_controlled_u3& operator=(fused_adj_multi_controlled_u3 const&) = delete;
      fused_adj_multi_controlled_u3(fused_adj_multi_controlled_u3&&) = delete;
      fused_adj_multi_controlled_u3& operator=(fused_adj_multi_controlled_u3&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_multi_controlled_u3<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_U3_HPP
