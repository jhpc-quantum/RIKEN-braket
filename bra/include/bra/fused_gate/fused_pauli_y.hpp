#ifndef BRA_FUSED_GATE_FUSED_PAULI_Y_HPP
# define BRA_FUSED_GATE_FUSED_PAULI_Y_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_pauli_y(::bra::qubit_type const qubit);

      ~fused_pauli_y() = default;
      fused_pauli_y(fused_pauli_y const&) = delete;
      fused_pauli_y& operator=(fused_pauli_y const&) = delete;
      fused_pauli_y(fused_pauli_y&&) = delete;
      fused_pauli_y& operator=(fused_pauli_y&&) = delete;
...
# undef DO_CALL
    }; // class fused_pauli_y<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PAULI_Y_HPP
