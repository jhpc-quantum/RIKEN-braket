#ifndef BRA_FUSED_GATE_FUSED_NOT_HPP
# define BRA_FUSED_GATE_FUSED_NOT_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_not_(::bra::qubit_type const qubit);

      ~fused_not_() = default;
      fused_not_(fused_not_ const&) = delete;
      fused_not_& operator=(fused_not_ const&) = delete;
      fused_not_(fused_not_&&) = delete;
      fused_not_& operator=(fused_not_&&) = delete;
...
# undef DO_CALL
    }; // class fused_not_<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_NOT_HPP
