#ifndef BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_Y_ROTATION_HALF_PI_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_Y_ROTATION_HALF_PI_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate
    {
     ...
     public:
      explicit fused_adj_controlled_y_rotation_half_pi(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit);

      ~fused_adj_controlled_y_rotation_half_pi() = default;
      fused_adj_controlled_y_rotation_half_pi(fused_adj_controlled_y_rotation_half_pi const&) = delete;
      fused_adj_controlled_y_rotation_half_pi& operator=(fused_adj_controlled_y_rotation_half_pi const&) = delete;
      fused_adj_controlled_y_rotation_half_pi(fused_adj_controlled_y_rotation_half_pi&&) = delete;
      fused_adj_controlled_y_rotation_half_pi& operator=(fused_adj_controlled_y_rotation_half_pi&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_controlled_y_rotation_half_pi
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_CONTROLLED_Y_ROTATION_HALF_PI_HPP
