#ifndef BRA_FUSED_GATE_FUSED_ADJ_SQRT_PAULI_ZZ_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_SQRT_PAULI_ZZ_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_sqrt_pauli_zz(::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_adj_sqrt_pauli_zz() = default;
      fused_adj_sqrt_pauli_zz(fused_adj_sqrt_pauli_zz const&) = delete;
      fused_adj_sqrt_pauli_zz& operator=(fused_adj_sqrt_pauli_zz const&) = delete;
      fused_adj_sqrt_pauli_zz(fused_adj_sqrt_pauli_zz&&) = delete;
      fused_adj_sqrt_pauli_zz& operator=(fused_adj_sqrt_pauli_zz&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_sqrt_pauli_zz<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_SQRT_PAULI_ZZ_HPP
