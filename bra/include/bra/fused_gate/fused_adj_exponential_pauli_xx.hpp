#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XX_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XX_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_pauli_xx final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_xx(::bra::real_type const phase, ::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_adj_exponential_pauli_xx() = default;
      fused_adj_exponential_pauli_xx(fused_adj_exponential_pauli_xx const&) = delete;
      fused_adj_exponential_pauli_xx& operator=(fused_adj_exponential_pauli_xx const&) = delete;
      fused_adj_exponential_pauli_xx(fused_adj_exponential_pauli_xx&&) = delete;
      fused_adj_exponential_pauli_xx& operator=(fused_adj_exponential_pauli_xx&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_pauli_xx<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_XX_HPP
