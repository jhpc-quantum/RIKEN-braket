#ifndef BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_PAULI_ZN_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_PAULI_ZN_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_multi_controlled_exponential_pauli_zn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_exponential_pauli_zn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_adj_multi_controlled_exponential_pauli_zn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits);
      explicit fused_adj_multi_controlled_exponential_pauli_zn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_adj_multi_controlled_exponential_pauli_zn() = default;
      fused_adj_multi_controlled_exponential_pauli_zn(fused_adj_multi_controlled_exponential_pauli_zn const&) = delete;
      fused_adj_multi_controlled_exponential_pauli_zn& operator=(fused_adj_multi_controlled_exponential_pauli_zn const&) = delete;
      fused_adj_multi_controlled_exponential_pauli_zn(fused_adj_multi_controlled_exponential_pauli_zn&&) = delete;
      fused_adj_multi_controlled_exponential_pauli_zn& operator=(fused_adj_multi_controlled_exponential_pauli_zn&&) = delete;
...
#   define CALL_ADJ_EXPONENTIAL_PAULI_Z(z, num_control_qubits, num_target_qubits) \
    ...
    auto call_adj_exponential_pauli_z_ ## num_target_qubits ## _ ## num_control_qubits(\
      Iterator const first, ::bra::state_integer_type const fused_index_wo_qubits,\
...
BOOST_PP_REPEAT_FROM_TO(0, BOOST_PP_INC(BOOST_PP_SUB(BRA_MAX_NUM_FUSED_QUBITS, num_target_qubits)), CALL_ADJ_EXPONENTIAL_PAULI_Z, num_target_qubits)
...
#endif // BRA_FUSED_GATE_FUSED_ADJ_MULTI_CONTROLLED_EXPONENTIAL_PAULI_ZN_HPP
