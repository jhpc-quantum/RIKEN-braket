#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_V_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_V_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_v final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_v(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_v(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_v() = default;
      fused_multi_controlled_v(fused_multi_controlled_v const&) = delete;
      fused_multi_controlled_v& operator=(fused_multi_controlled_v const&) = delete;
      fused_multi_controlled_v(fused_multi_controlled_v&&) = delete;
      fused_multi_controlled_v& operator=(fused_multi_controlled_v&&) = delete;
...
# undef DO_CALL
    }; // class fused_multi_controlled_v<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_V_HPP
