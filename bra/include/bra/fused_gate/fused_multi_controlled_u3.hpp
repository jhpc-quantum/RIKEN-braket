#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U3_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U3_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_u3 final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_u3() = default;
      fused_multi_controlled_u3(fused_multi_controlled_u3 const&) = delete;
      fused_multi_controlled_u3& operator=(fused_multi_controlled_u3 const&) = delete;
      fused_multi_controlled_u3(fused_multi_controlled_u3&&) = delete;
      fused_multi_controlled_u3& operator=(fused_multi_controlled_u3&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_multi_controlled_u3<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_U3_HPP
