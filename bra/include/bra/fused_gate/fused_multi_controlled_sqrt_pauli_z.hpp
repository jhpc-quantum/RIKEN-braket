#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_sqrt_pauli_z final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_sqrt_pauli_z(std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_sqrt_pauli_z(std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_sqrt_pauli_z() = default;
      fused_multi_controlled_sqrt_pauli_z(fused_multi_controlled_sqrt_pauli_z const&) = delete;
      fused_multi_controlled_sqrt_pauli_z& operator=(fused_multi_controlled_sqrt_pauli_z const&) = delete;
      fused_multi_controlled_sqrt_pauli_z(fused_multi_controlled_sqrt_pauli_z&&) = delete;
      fused_multi_controlled_sqrt_pauli_z& operator=(fused_multi_controlled_sqrt_pauli_z&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_multi_controlled_sqrt_pauli_z<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_SQRT_PAULI_Z_HPP
