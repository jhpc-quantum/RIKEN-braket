#ifndef BRA_FUSED_GATE_FUSED_PAULI_XX_HPP
# define BRA_FUSED_GATE_FUSED_PAULI_XX_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_pauli_xx(::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2);

      ~fused_pauli_xx() = default;
      fused_pauli_xx(fused_pauli_xx const&) = delete;
      fused_pauli_xx& operator=(fused_pauli_xx const&) = delete;
      fused_pauli_xx(fused_pauli_xx&&) = delete;
      fused_pauli_xx& operator=(fused_pauli_xx&&) = delete;
...
# undef DO_CALL
    }; // class fused_pauli_xx<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PAULI_XX_HPP
