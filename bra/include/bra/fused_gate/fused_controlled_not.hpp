#ifndef BRA_FUSED_GATE_FUSED_CONTROLLED_NOT_HPP
# define BRA_FUSED_GATE_FUSED_CONTROLLED_NOT_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_controlled_not final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_controlled_not(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit);

      ~fused_controlled_not() = default;
      fused_controlled_not(fused_controlled_not const&) = delete;
      fused_controlled_not& operator=(fused_controlled_not const&) = delete;
      fused_controlled_not(fused_controlled_not&&) = delete;
      fused_controlled_not& operator=(fused_controlled_not&&) = delete;
...
# undef DO_CALL
    }; // class fused_controlled_not<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_CONTROLLED_NOT_HPP
