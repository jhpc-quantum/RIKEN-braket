#ifndef BRA_FUSED_GATE_FUSED_ADJ_PHASE_SHIFT_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_PHASE_SHIFT_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate
    {
     ...
     public:
      explicit fused_adj_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const qubit);

      ~fused_adj_phase_shift() = default;
      fused_adj_phase_shift(fused_adj_phase_shift const&) = delete;
      fused_adj_phase_shift& operator=(fused_adj_phase_shift const&) = delete;
      fused_adj_phase_shift(fused_adj_phase_shift&&) = delete;
      fused_adj_phase_shift& operator=(fused_adj_phase_shift&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_phase_shift
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_PHASE_SHIFT_HPP
