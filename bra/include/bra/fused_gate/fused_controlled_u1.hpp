#ifndef BRA_FUSED_GATE_FUSED_CONTROLLED_U1_HPP
# define BRA_FUSED_GATE_FUSED_CONTROLLED_U1_HPP
  ...
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate
    {
     ...
     public:
      ...
      fused_controlled_u1& operator=(fused_controlled_u1 const&) = delete;
      fused_controlled_u1(fused_controlled_u1&&) = delete;
...
# undef DO_CALL
    }; // class fused_controlled_u1
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_CONTROLLED_U1_HPP
