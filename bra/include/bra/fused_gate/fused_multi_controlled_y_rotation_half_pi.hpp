#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_Y_ROTATION_HALF_PI_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_Y_ROTATION_HALF_PI_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_y_rotation_half_pi final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_y_rotation_half_pi(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_y_rotation_half_pi(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_y_rotation_half_pi() = default;
      fused_multi_controlled_y_rotation_half_pi(fused_multi_controlled_y_rotation_half_pi const&) = delete;
      fused_multi_controlled_y_rotation_half_pi& operator=(fused_multi_controlled_y_rotation_half_pi const&) = delete;
      fused_multi_controlled_y_rotation_half_pi(fused_multi_controlled_y_rotation_half_pi&&) = delete;
      fused_multi_controlled_y_rotation_half_pi& operator=(fused_multi_controlled_y_rotation_half_pi&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_multi_controlled_y_rotation_half_pi<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_Y_ROTATION_HALF_PI_HPP
