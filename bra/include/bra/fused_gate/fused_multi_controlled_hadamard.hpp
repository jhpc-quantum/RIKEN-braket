#ifndef BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_HADAMARD_HPP
# define BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_HADAMARD_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_multi_controlled_hadamard final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_multi_controlled_hadamard(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits);
      explicit fused_multi_controlled_hadamard(::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits);

      ~fused_multi_controlled_hadamard() = default;
      fused_multi_controlled_hadamard(fused_multi_controlled_hadamard const&) = delete;
      fused_multi_controlled_hadamard& operator=(fused_multi_controlled_hadamard const&) = delete;
      fused_multi_controlled_hadamard(fused_multi_controlled_hadamard&&) = delete;
      fused_multi_controlled_hadamard& operator=(fused_multi_controlled_hadamard&&) = delete;
...
# undef DO_CALL
    }; // class fused_multi_controlled_hadamard<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_MULTI_CONTROLLED_HADAMARD_HPP
