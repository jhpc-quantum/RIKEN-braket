#ifndef BRA_FUSED_GATE_FUSED_U1_HPP
# define BRA_FUSED_GATE_FUSED_U1_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_u1(::bra::real_type const phase, ::bra::control_qubit_type const control_qubit);

      ~fused_u1() = default;
      fused_u1(fused_u1 const&) = delete;
      fused_u1& operator=(fused_u1 const&) = delete;
      fused_u1(fused_u1&&) = delete;
      fused_u1& operator=(fused_u1&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_u1<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_U1_HPP
