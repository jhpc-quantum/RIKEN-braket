#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YN_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YN_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_pauli_yn final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& qubits);
      explicit fused_adj_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& qubits);

      ~fused_adj_exponential_pauli_yn() = default;
      fused_adj_exponential_pauli_yn(fused_adj_exponential_pauli_yn const&) = delete;
      fused_adj_exponential_pauli_yn& operator=(fused_adj_exponential_pauli_yn const&) = delete;
      fused_adj_exponential_pauli_yn(fused_adj_exponential_pauli_yn&&) = delete;
      fused_adj_exponential_pauli_yn& operator=(fused_adj_exponential_pauli_yn&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_pauli_yn<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_YN_HPP
