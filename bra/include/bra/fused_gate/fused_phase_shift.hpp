#ifndef BRA_FUSED_GATE_FUSED_PHASE_SHIFT_HPP
# define BRA_FUSED_GATE_FUSED_PHASE_SHIFT_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::control_qubit_type const control_qubit);

      ~fused_phase_shift() = default;
      fused_phase_shift(fused_phase_shift const&) = delete;
      fused_phase_shift& operator=(fused_phase_shift const&) = delete;
      fused_phase_shift(fused_phase_shift&&) = delete;
      fused_phase_shift& operator=(fused_phase_shift&&) = delete;
...
# undef DO_CALL
    ...
    }; // class fused_phase_shift<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_PHASE_SHIFT_HPP
