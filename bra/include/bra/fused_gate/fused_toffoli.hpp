#ifndef BRA_FUSED_GATE_FUSED_TOFFOLI_HPP
# define BRA_FUSED_GATE_FUSED_TOFFOLI_HPP
...
namespace bra
{
  namespace fused_gate
  {
      ...
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_toffoli(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit1, ::bra::control_qubit_type const control_qubit2);

      ~fused_toffoli() = default;
      fused_toffoli(fused_toffoli const&) = delete;
      fused_toffoli& operator=(fused_toffoli const&) = delete;
      fused_toffoli(fused_toffoli&&) = delete;
      fused_toffoli& operator=(fused_toffoli&&) = delete;
...
# undef DO_CALL
    }; // class fused_toffoli<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_TOFFOLI_HPP
