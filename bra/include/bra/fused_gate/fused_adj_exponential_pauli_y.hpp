#ifndef BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Y_HPP
# define BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Y_HPP
...
namespace bra
{
  namespace fused_gate
  {
    ...
    class fused_adj_exponential_pauli_y final
      : public ::bra::fused_gate::fused_gate<Iterator>
    {
     ...
     public:
      explicit fused_adj_exponential_pauli_y(::bra::real_type const phase, ::bra::qubit_type const qubit);

      ~fused_adj_exponential_pauli_y() = default;
      fused_adj_exponential_pauli_y(fused_adj_exponential_pauli_y const&) = delete;
      fused_adj_exponential_pauli_y& operator=(fused_adj_exponential_pauli_y const&) = delete;
      fused_adj_exponential_pauli_y(fused_adj_exponential_pauli_y&&) = delete;
      fused_adj_exponential_pauli_y& operator=(fused_adj_exponential_pauli_y&&) = delete;
...
# undef DO_CALL
    }; // class fused_adj_exponential_pauli_y<Iterator>
  } // namespace fused_gate
} // namespace bra


#endif // BRA_FUSED_GATE_FUSED_ADJ_EXPONENTIAL_PAULI_Y_HPP
