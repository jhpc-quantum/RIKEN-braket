#ifndef BRA_PAGED_MPI_STATE_HPP
# define BRA_PAGED_MPI_STATE_HPP
...
#   endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    ...
    ~paged_mpi_state() = default;
    paged_mpi_state(paged_mpi_state const&) = default;
    paged_mpi_state& operator=(paged_mpi_state const&) = default;
    paged_mpi_state(paged_mpi_state&&) = default;
    paged_mpi_state& operator=(paged_mpi_state&&) = default;
...
#   include <bra/paged_mpi_state_impl.hpp>

# endif // BRA_NO_MPI

#endif // BRA_PAGED_MPI_STATE_HPP
