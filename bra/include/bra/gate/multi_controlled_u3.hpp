#ifndef BRA_GATE_MULTI_CONTROLLED_U3_HPP
# define BRA_GATE_MULTI_CONTROLLED_U3_HPP
...
namespace bra
{
  namespace gate
  {
    class multi_controlled_u3 final
      : public ::bra::gate::gate
    {
     ...
     public:
      ...
      multi_controlled_u3(multi_controlled_u3 const&) = delete;
      multi_controlled_u3& operator=(multi_controlled_u3 const&) = delete;
      multi_controlled_u3(multi_controlled_u3&&) = delete;
      multi_controlled_u3& operator=(multi_controlled_u3&&) = delete;
    ...
    }; // class multi_controlled_u3
  } // namespace gate
} // namespace bra


#endif // BRA_GATE_MULTI_CONTROLLED_U3_HPP
