...
namespace bra
{
  namespace gate
  {
      ...
      : public ::bra::gate::gate
    {
     ...
     public:
      adj_exponential_pauli_yn(real_type const phase, std::vector<qubit_type> const& qubits);
      adj_exponential_pauli_yn(real_type const phase, std::vector<qubit_type>&& qubits);
