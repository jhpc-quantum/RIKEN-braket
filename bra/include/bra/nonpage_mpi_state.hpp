#ifndef BRA_NONPAGE_MPI_STATE_HPP
# define BRA_NONPAGE_MPI_STATE_HPP
...
#   endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
   ...
   protected:
    template <typename... StateConstructorArgs>
    nonpage_mpi_state(
      ...
      StateConstructorArgs&&... state_constructor_args)
...
#   endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    ...
    ~nonpage_mpi_state() = default;
    nonpage_mpi_state(nonpage_mpi_state const&) = default;
    nonpage_mpi_state& operator=(nonpage_mpi_state const&) = default;
    nonpage_mpi_state(nonpage_mpi_state&&) = default;
    nonpage_mpi_state& operator=(nonpage_mpi_state&&) = default;
...
#   include <bra/nonpage_mpi_state_impl.hpp>

# endif // BRA_NO_MPI

#endif // BRA_NONPAGE_MPI_STATE_HPP
