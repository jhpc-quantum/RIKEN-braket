#ifndef BRA_NONPAGE_MPI_STATE_IMPL_HPP
# define BRA_NONPAGE_MPI_STATE_IMPL_HPP
...
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  struct nonpage_mpi_fused_gate_caller
  {
    ...
    auto call_in_execute(
      ...
      UnsortedFusedQubitsOrMasks const& unsorted_fused_qubits_or_masks,
      SortedFusedQubitsWithSentinelOrIndexMasks const& sorted_fused_qubits_with_sentinel_or_index_masks,
      ::bra::state_integer_type const unit_qubit_value) const
    -> typename std::enable_if<
         std::is_same<typename std::decay<First>::type, Iterator>::value>::type
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  typename nonpage_mpi_state<MpiPolicy>::data_type nonpage_mpi_state<MpiPolicy>::generate_initial_data(
  ...
  template <typename MpiPolicy>
  unsigned int nonpage_mpi_state<MpiPolicy>::do_num_page_qubits() const
  { return 0u; }

  template <typename MpiPolicy>
  unsigned int nonpage_mpi_state<MpiPolicy>::do_num_pages() const
  { return 1u; }

  template <typename MpiPolicy>
  auto nonpage_mpi_state<MpiPolicy>::generate_probability() -> real_type
  {
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_i_gate(qubit_type const qubit)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_ic_gate(control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_ii_gate(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_in_gate(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_hadamard(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_not_(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_x(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_xx(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_xn(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_y(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_yy(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_yn(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_z(control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_zz(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_pauli_zn(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_swap(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_sqrt_pauli_x(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_sqrt_pauli_x(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_sqrt_pauli_y(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_sqrt_pauli_y(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_sqrt_pauli_z(control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_sqrt_pauli_z(control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_sqrt_pauli_zz(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_sqrt_pauli_zz(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_sqrt_pauli_zn(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_sqrt_pauli_zn(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_u1(real_type const phase, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_u1(real_type const phase, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_u2(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_u2(
    real_type const phase1, real_type const phase2, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_u3(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_u3(
    real_type const phase1, real_type const phase2, real_type const phase3,
    qubit_type const qubit)
  {
    if (is_in_fusion_)
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_phase_shift(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_phase_shift(
    complex_type const& phase_coefficient, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_x_rotation_half_pi(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_x_rotation_half_pi(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_y_rotation_half_pi(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_y_rotation_half_pi(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_x(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_x(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_xx(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_xx(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_xn(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_xn(
    real_type const phase, std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_y(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_y(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_yy(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_yy(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_yn(
    real_type const phase, std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_yn(
    real_type const phase, std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_z(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_z(real_type const phase, qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_zz(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_zz(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_pauli_zn(
    real_type const phase, std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_pauli_zn(
    real_type const phase, std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_exponential_swap(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_exponential_swap(
    real_type const phase, qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_toffoli(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  ket::gate::outcome nonpage_mpi_state<MpiPolicy>::do_projective_measurement(
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_expectation_values(yampi::rank const root)
  {
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_amplitudes(yampi::rank const root, std::vector< ::bra::state_integer_type > const& amplitude_indices)
  {
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_measure(yampi::rank const root)
  {
    measured_value_
      = ket::mpi::measure(
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_generate_events(yampi::rank const root, int const num_events, int const seed)
  {
    if (seed < 0)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_expectation_value(std::string const& operator_literal_or_variable_name, std::vector<qubit_type> const& operated_qubits)
  {
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_inner_product(std::string const& remote_circuit_index_or_all)
  {
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_inner_product(std::string const& remote_circuit_index_or_all, std::string const& operator_literal_or_variable_name, std::vector<qubit_type> const& operated_qubits)
  {
    auto remote_circuit_index = -1;
    auto is_all = false;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_fidelity(std::string const& remote_circuit_index_or_all)
  {
    auto remote_circuit_index = -1;
    auto is_all = false;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_fidelity(std::string const& remote_circuit_index_or_all, std::string const& operator_literal_or_variable_name, std::vector<qubit_type> const& operated_qubits)
  {
    auto remote_circuit_index = -1;
    auto is_all = false;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_shor_box(
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_begin_fusion()
  { }

  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_end_fusion()
  {
...
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    auto const call_fused_gates
      = nonpage_mpi_fused_gate_caller<fused_gate_iterator, cache_aware_fused_gate_iterator>{
          fused_gates_, cache_aware_fused_gates_, to_qubit_index_in_fused_gates};
# else // !defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) || defined(KET_USE_ON_CACHE_STATE_VECTOR)
    auto const call_fused_gates
      = nonpage_mpi_fused_gate_caller<fused_gate_iterator>{fused_gates_, to_qubit_index_in_fused_gates};
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_clear(qubit_type const qubit)
  {
    ket::mpi::gate::clear(
      mpi_policy_, parallel_policy_,
      data_, permutation_, buffer_, circuit_communicator_, environment_, qubit);
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_set(qubit_type const qubit)
  {
    ket::mpi::gate::set(
      mpi_policy_, parallel_policy_,
      data_, permutation_, buffer_, circuit_communicator_, environment_, qubit);
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_i_gate(
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_ic_gate(
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_in_gate(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_ic_gate(std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
      return;
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_hadamard(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_hadamard(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_not(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_not(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_pauli_x(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_pauli_xn(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_pauli_y(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_pauli_yn(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_pauli_z(
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_pauli_z(std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_pauli_zn(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_swap(qubit_type const target_qubit1, qubit_type const target_qubit2,
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_sqrt_pauli_x(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_sqrt_pauli_x(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_sqrt_pauli_x(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_sqrt_pauli_x(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_sqrt_pauli_y(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_sqrt_pauli_y(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_sqrt_pauli_y(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_sqrt_pauli_y(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_sqrt_pauli_z(
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_sqrt_pauli_z(
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_sqrt_pauli_z(std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_sqrt_pauli_z(std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_sqrt_pauli_zn(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_sqrt_pauli_zn(std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_phase_shift(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_phase_shift(
    complex_type const& phase_coefficient,
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_phase_shift(complex_type const& phase_coefficient,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_phase_shift(complex_type const& phase_coefficient,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_u1(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_u1(
    real_type const phase, control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_u1(real_type const phase, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_u1(real_type const phase, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_u2(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_u2(
    real_type const phase1, real_type const phase2, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_u2(real_type const phase1, real_type const phase2, qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_u2(real_type const phase1, real_type const phase2, qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_u3(
    real_type const phase1, real_type const phase2, real_type const phase3,
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_u3(
    real_type const phase1, real_type const phase2, real_type const phase3,
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_u3(real_type const phase1, real_type const phase2, real_type const phase3,
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_u3(real_type const phase1, real_type const phase2, real_type const phase3,
    qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_x_rotation_half_pi(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_x_rotation_half_pi(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_x_rotation_half_pi(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_x_rotation_half_pi(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_y_rotation_half_pi(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_y_rotation_half_pi(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_y_rotation_half_pi(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_y_rotation_half_pi(qubit_type const target_qubit, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_exponential_pauli_x(
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_exponential_pauli_x(
    real_type const phase, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_exponential_pauli_xn(real_type const phase,
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_exponential_pauli_xn(real_type const phase,
    std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_exponential_pauli_y(
    real_type const phase, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_exponential_pauli_y(
    real_type const phase, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_exponential_pauli_yn(real_type const phase,
    std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_exponential_pauli_yn(real_type const phase,
    std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_controlled_exponential_pauli_z(
    real_type const phase, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_controlled_exponential_pauli_z(
    real_type const phase, qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_exponential_pauli_z(real_type const phase, qubit_type const target_qubit,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_exponential_pauli_z(real_type const phase, qubit_type const target_qubit,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_exponential_pauli_zn(real_type const phase,
    std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_exponential_pauli_zn(real_type const phase,
    std::vector<qubit_type> const& target_qubits, std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_multi_controlled_exponential_swap(real_type const phase, qubit_type const target_qubit1, qubit_type const target_qubit2,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  template <typename MpiPolicy>
  void nonpage_mpi_state<MpiPolicy>::do_adj_multi_controlled_exponential_swap(real_type const phase, qubit_type const target_qubit1, qubit_type const target_qubit2,
    std::vector<control_qubit_type> const& control_qubits)
  {
    if (is_in_fusion_)
    {
...
#endif // BRA_NONPAGE_MPI_STATE_IMPL_HPP
