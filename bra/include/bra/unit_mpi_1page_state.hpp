#ifndef BRA_UNIT_MPI_1PAGE_STATE_HPP
# define BRA_UNIT_MPI_1PAGE_STATE_HPP
...
namespace bra
{
  class unit_mpi_1page_state final
    : public ::bra::state
  {
   ...
   public:
    ...
    ~unit_mpi_1page_state() = default;
    unit_mpi_1page_state(unit_mpi_1page_state const&) = delete;
    unit_mpi_1page_state& operator=(unit_mpi_1page_state const&) = delete;
    unit_mpi_1page_state(unit_mpi_1page_state&&) = delete;
    unit_mpi_1page_state& operator=(unit_mpi_1page_state&&) = delete;
  ...
  }; // class unit_mpi_1page_state
} // namespace bra


# endif // BRA_NO_MPI

#endif // BRA_UNIT_MPI_1PAGE_STATE_HPP
