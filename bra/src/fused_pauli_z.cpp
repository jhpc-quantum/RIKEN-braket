...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, control_qubit_); }
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, qubit_masks, index_masks, control_qubit_); }
...
#if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  template class fused_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator >>;
# ifndef BRA_NO_MPI
  template class fused_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator >>;
# endif // BRA_NO_MPI
#endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  } // namespace fused_gate
} // namespace bra
