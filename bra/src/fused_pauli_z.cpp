...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_pauli_z<Iterator>::fused_pauli_z(::bra::qubit_type const qubit)
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, qubit_); }
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::pauli_z(first, fused_index_wo_qubits, qubit_masks, index_masks, qubit_); }
