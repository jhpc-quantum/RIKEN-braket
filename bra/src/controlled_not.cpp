...
namespace bra
{
  namespace gate
  {
    std::string const controlled_not::name_ = "CNOT";
    ...
    { return state.controlled_not(target_qubit_, control_qubit_); }

    std::string const& controlled_not::do_name() const { return name_; }
    std::string controlled_not::do_representation(
