...
namespace bra
{
  ...
  {
    fused_adj_exponential_pauli_y::fused_adj_exponential_pauli_y(::bra::real_type const phase, ::bra::qubit_type const qubit)
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_exponential_pauli_y::do_call(\
