...
namespace bra
{
  ...
  {
    fused_multi_controlled_phase_shift::fused_multi_controlled_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_coefficient_{phase_coefficient}, target_qubit_{target_qubit}, control_qubits_{control_qubits}
    { }

    fused_multi_controlled_phase_shift::fused_multi_controlled_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits)
    ...
    [[noreturn]] auto fused_multi_controlled_phase_shift::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_multi_controlled_phase_shift::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
