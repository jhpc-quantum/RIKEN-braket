...
namespace bra
{
  ...
  {
    fused_pauli_xn::fused_pauli_xn(std::vector< ::bra::qubit_type > const& qubits)
      : ::bra::fused_gate::fused_gate{}, qubits_{qubits}
    { }

    fused_pauli_xn::fused_pauli_xn(std::vector< ::bra::qubit_type >&& qubits)
      : ::bra::fused_gate::fused_gate{}, qubits_{std::move(qubits)}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_pauli_xn::do_call(
