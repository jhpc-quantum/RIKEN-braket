...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::phase_shift_coeff(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, phase_coefficient_, control_qubit1_, control_qubit2_); }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    auto fused_controlled_phase_shift<Iterator>::do_call(\
    ...
    { ::ket::gate::fused::phase_shift_coeff(first, fused_index_wo_qubits, qubit_masks, index_masks, phase_coefficient_, control_qubit1_, control_qubit2_); }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
