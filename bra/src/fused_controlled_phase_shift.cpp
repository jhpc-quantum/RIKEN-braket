...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_controlled_phase_shift<Iterator>::fused_controlled_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::control_qubit_type const control_qubit1, ::bra::control_qubit_type const control_qubit2)
      ...
      std::vector< ::bra::bit_integer_type > const& to_qubit_index_in_fused_gates) const -> void
    {
      if (unsorted_fused_qubits.empty() and (is_control_qubit1_enabled_ or is_control_qubit2_enabled_))
        throw std::runtime_error{"fused_controlled_phase_shift requires at least one fused qubit"};
    ...
    template <typename Iterator>
    auto fused_controlled_phase_shift<Iterator>::do_call_in_execute(
      ...
      ::bra::state_integer_type const) const -> void
    {
      ...
      ::ket::gate::fused::runtime::ranges::phase_shift_coeff(
        ...
        first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel,
        phase_coefficient_, enabled_control_qubits);
    }
    ...
    template <typename Iterator>
    auto fused_controlled_phase_shift<Iterator>::do_disable_control_qubits(
...
#ifndef KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_controlled_phase_shift<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::qubit_type >>;
#   ifndef BRA_NO_MPI
    template class fused_controlled_phase_shift<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::qubit_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#else // KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_controlled_phase_shift<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::state_integer_type >>;
#   ifndef BRA_NO_MPI
    template class fused_controlled_phase_shift<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::state_integer_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#endif // KET_USE_BIT_MASKS_EXPLICITLY
  } // namespace fused_gate
