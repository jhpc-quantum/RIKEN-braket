...
namespace bra
{
  ...
  void general_mpi_2page_state::do_pauli_x(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_adj_pauli_x(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_pauli_y(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_adj_pauli_y(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_pauli_z(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_adj_pauli_z(
    qubit_type const qubit)
  {
  ...
  void general_mpi_2page_state::do_depolarizing_channel(real_type const px, real_type const py, real_type const pz, int const seed)
  {
