...
# ifndef BRAKET_ENABLE_MULTIPLE_USES_OF_BUFFER_FOR_ONE_DATA_TRANSFER_IF_NO_PAGE_EXISTS
  simple_mpi_state::simple_mpi_state(
    ...
    : ::bra::nonpage_mpi_state<mpi_policy_type>{initial_integer, num_local_qubits, num_threads_per_process, num_on_cache_qubits, mpi_policy_type{}, circuit_communicator, environment, total_num_qubits, seed, is_depolarizing_channel, depolarizing_px, depolarizing_py, depolarizing_pz, uses_depolarizing_seed, depolarizing_seed, circuit_communicator, intercircuit_communicator, circuit_index, intercommunicators, environment}
  { }
  ...
  simple_mpi_state::simple_mpi_state(
    ...
    std::vector<yampi::intercommunicator> const& intercommunicators,
    yampi::environment const& environment)
    : ::bra::nonpage_mpi_state<mpi_policy_type>{initial_integer, num_local_qubits, num_threads_per_process, num_on_cache_qubits, mpi_policy_type{}, circuit_communicator, environment, initial_permutation, seed, is_depolarizing_channel, depolarizing_px, depolarizing_py, depolarizing_pz, uses_depolarizing_seed, depolarizing_seed, circuit_communicator, intercircuit_communicator, circuit_index, intercommunicators, environment}
  { }
# else // BRAKET_ENABLE_MULTIPLE_USES_OF_BUFFER_FOR_ONE_DATA_TRANSFER_IF_NO_PAGE_EXISTS
  simple_mpi_state::simple_mpi_state(
    ...
    std::vector<yampi::intercommunicator> const& intercommunicators,
    yampi::environment const& environment)
    : ::bra::nonpage_mpi_state<mpi_policy_type>{initial_integer, num_local_qubits, num_threads_per_process, num_on_cache_qubits, mpi_policy_type{}, circuit_communicator, environment, total_num_qubits, seed, is_depolarizing_channel, depolarizing_px, depolarizing_py, depolarizing_pz, uses_depolarizing_seed, depolarizing_seed, num_elements_in_buffer, circuit_communicator, intercircuit_communicator, circuit_index, intercommunicators, environment}
  { }
  ...
  simple_mpi_state::simple_mpi_state(
    ...
    std::vector<yampi::intercommunicator> const& intercommunicators,
    yampi::environment const& environment)
    : ::bra::nonpage_mpi_state<mpi_policy_type>{initial_integer, num_local_qubits, num_threads_per_process, num_on_cache_qubits, mpi_policy_type{}, circuit_communicator, environment, initial_permutation, seed, is_depolarizing_channel, depolarizing_px, depolarizing_py, depolarizing_pz, uses_depolarizing_seed, depolarizing_seed, num_elements_in_buffer, circuit_communicator, intercircuit_communicator, circuit_index, intercommunicators, environment}
  { }
