...
namespace bra
{
  namespace fused_gate
  {
    ...
    template <typename Iterator>
    [[noreturn]] auto fused_controlled_u1<Iterator>::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::phase_shift(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, phase_, control_qubit1_, control_qubit2_); }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    auto fused_controlled_u1<Iterator>::do_call(\
    ...
    { ::ket::gate::fused::phase_shift(first, fused_index_wo_qubits, qubit_masks, index_masks, phase_, control_qubit1_, control_qubit2_); }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
