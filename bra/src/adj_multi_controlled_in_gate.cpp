...
#include <bra/gate/adj_multi_controlled_in_gate.hpp>
...
namespace bra
{
  namespace gate
  {
    adj_multi_controlled_in_gate::adj_multi_controlled_in_gate(
    ...
    ::bra::state& adj_multi_controlled_in_gate::do_apply(::bra::state& state) const
    { return state.adj_multi_controlled_in_gate(target_qubits_, control_qubits_); }

    std::string const& adj_multi_controlled_in_gate::do_name() const { return name_; }
    std::string adj_multi_controlled_in_gate::do_representation(
