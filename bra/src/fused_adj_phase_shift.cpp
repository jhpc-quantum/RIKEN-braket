...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_adj_phase_shift<Iterator>::fused_adj_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const qubit)
      : ::bra::fused_gate::fused_gate<Iterator>{}, phase_coefficient_{phase_coefficient}, qubit_{qubit}
    { }
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::adj_phase_shift_coeff(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, phase_coefficient_, qubit_); }
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::adj_phase_shift_coeff(first, fused_index_wo_qubits, qubit_masks, index_masks, phase_coefficient_, qubit_); }
