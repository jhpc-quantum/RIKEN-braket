...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_adj_phase_shift<Iterator>::fused_adj_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::control_qubit_type const control_qubit)
      : ::bra::fused_gate::fused_gate<Iterator>{}, phase_coefficient_{phase_coefficient}, control_qubit_{control_qubit}, is_control_qubit_enabled_{true}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    template <typename Iterator>
    [[noreturn]] auto fused_adj_phase_shift<Iterator>::do_call(
...
#undef DO_CALL
    ...
    template <typename Iterator>
    auto fused_adj_phase_shift<Iterator>::do_disable_control_qubits(
