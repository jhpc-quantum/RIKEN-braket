...
namespace bra
{
  ...
  {
    fused_adj_phase_shift::fused_adj_phase_shift(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const qubit)
      : ::bra::fused_gate::fused_gate{}, phase_coefficient_{phase_coefficient}, qubit_{qubit}
    { }
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_phase_shift::do_call(\
