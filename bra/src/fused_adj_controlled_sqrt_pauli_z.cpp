...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_adj_controlled_sqrt_pauli_z<Iterator>::fused_adj_controlled_sqrt_pauli_z(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit)
...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::sqrt_pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, target_qubit_, control_qubit_); }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    auto fused_adj_controlled_sqrt_pauli_z<Iterator>::do_call(\
    ...
    { ::ket::gate::fused::sqrt_pauli_z(first, fused_index_wo_qubits, qubit_masks, index_masks, target_qubit_, control_qubit_); }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
