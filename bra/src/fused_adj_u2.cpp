...
namespace bra
{
  ...
  {
    fused_adj_u2::fused_adj_u2(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::qubit_type const qubit)
      : ::bra::fused_gate::fused_gate{}, phase1_{phase1}, phase2_{phase2}, qubit_{qubit}
    { }
