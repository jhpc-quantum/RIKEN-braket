...
namespace bra
{
  ...
  {
    fused_adj_exponential_pauli_xx::fused_adj_exponential_pauli_xx(::bra::real_type const phase, ::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, qubit1_{qubit1}, qubit2_{qubit2}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_adj_exponential_pauli_xx::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_exponential_pauli_xx::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
    ...
    { ::ket::gate::fused::adj_exponential_pauli_x(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, phase_, qubit1_, qubit2_); }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_exponential_pauli_xx::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
    ...
    { ::ket::gate::fused::adj_exponential_pauli_x(first, fused_index_wo_qubits, qubit_masks, index_masks, phase_, qubit1_, qubit2_); }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
