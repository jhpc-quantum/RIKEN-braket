...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_sqrt_pauli_z<Iterator>::fused_sqrt_pauli_z(::bra::control_qubit_type const control_qubit)
      : ::bra::fused_gate::fused_gate<Iterator>{}, control_qubit_{control_qubit}, is_control_qubit_enabled_{true}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    template <typename Iterator>
    [[noreturn]] auto fused_sqrt_pauli_z<Iterator>::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    auto fused_sqrt_pauli_z<Iterator>::do_call(\
      Iterator const first, ::bra::state_integer_type const fused_index_wo_qubits,\
    ...
    {\
      if (is_control_qubit_enabled_)\
        ...
        ket::gate::fused::sqrt_pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel);\
    }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    ...
    {\
      if (is_control_qubit_enabled_)\
        ...
        ket::gate::fused::sqrt_pauli_z(first, fused_index_wo_qubits, qubit_masks, index_masks);\
    }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
...
#undef DO_CALL
    ...
    template <typename Iterator>
    auto fused_sqrt_pauli_z<Iterator>::do_disable_control_qubits(
    ...
    template class fused_sqrt_pauli_z< ::bra::data_type::iterator >;
    ...
    template class fused_sqrt_pauli_z< ::bra::paged_data_type::iterator >;
...
#ifndef KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_sqrt_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::qubit_type >>;
#   ifndef BRA_NO_MPI
    template class fused_sqrt_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::qubit_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#else // KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_sqrt_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::state_integer_type >>;
#   ifndef BRA_NO_MPI
    template class fused_sqrt_pauli_z<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::state_integer_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#endif // KET_USE_BIT_MASKS_EXPLICITLY
  } // namespace fused_gate
