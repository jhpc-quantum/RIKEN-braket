...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_toffoli<Iterator>::fused_toffoli(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit1, ::bra::control_qubit_type const control_qubit2)
      : ::bra::fused_gate::fused_gate<Iterator>{}, target_qubit_{target_qubit}, control_qubit1_{control_qubit1}, control_qubit2_{control_qubit2}, is_control_qubit1_enabled_{true}, is_control_qubit2_enabled_{true}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    template <typename Iterator>
    auto fused_toffoli<Iterator>::do_call(
      ...
      std::vector< ::bra::bit_integer_type > const& to_qubit_index_in_fused_gates) const -> void
    {
      if (unsorted_fused_qubits.size() < std::size_t{1u})
        throw std::runtime_error{"fused_toffoli requires at least one fused qubit"};
    ...
    template <typename Iterator>
    auto fused_toffoli<Iterator>::do_disable_control_qubits(
    ...
    -> void
    {
      is_control_qubit1_enabled_
        = is_control_qubit1_enabled_
          and std::none_of(first, last, [this](::bra::qubit_type const found_qubit) { return found_qubit == this->control_qubit1_; });
      is_control_qubit2_enabled_
        = is_control_qubit2_enabled_
          and std::none_of(first, last, [this](::bra::qubit_type const found_qubit) { return found_qubit == this->control_qubit2_; });
    }
    ...
    -> void
    {
      is_control_qubit1_enabled_
        = is_control_qubit1_enabled_
          and std::none_of(first, last, [this](::bra::control_qubit_type const found_qubit) { return found_qubit == this->control_qubit1_; });
      is_control_qubit2_enabled_
        = is_control_qubit2_enabled_
          and std::none_of(first, last, [this](::bra::control_qubit_type const found_qubit) { return found_qubit == this->control_qubit2_; });
    }

    template class fused_toffoli< ::bra::data_type::iterator >;
    ...
    template class fused_toffoli< ::bra::paged_data_type::iterator >;
...
#ifndef KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_toffoli<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::qubit_type >>;
#   ifndef BRA_NO_MPI
    template class fused_toffoli<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::qubit_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#else // KET_USE_BIT_MASKS_EXPLICITLY
# if defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
    template class fused_toffoli<ket::gate::utility::cache_aware_iterator< ::bra::data_type::iterator, ::bra::state_integer_type >>;
#   ifndef BRA_NO_MPI
    template class fused_toffoli<ket::gate::utility::cache_aware_iterator< ::bra::paged_data_type::iterator, ::bra::state_integer_type >>;
#   endif // BRA_NO_MPI
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
#endif // KET_USE_BIT_MASKS_EXPLICITLY
  } // namespace fused_gate
