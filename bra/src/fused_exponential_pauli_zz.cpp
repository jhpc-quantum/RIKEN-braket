...
namespace bra
{
  ...
  {
    fused_exponential_pauli_zz::fused_exponential_pauli_zz(::bra::real_type const phase, ::bra::qubit_type const qubit1, ::bra::qubit_type const qubit2)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, qubit1_{qubit1}, qubit2_{qubit2}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_exponential_pauli_zz::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_exponential_pauli_zz::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
