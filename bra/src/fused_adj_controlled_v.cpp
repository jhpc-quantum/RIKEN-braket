...
namespace bra
{
  ...
  {
    fused_adj_controlled_v::fused_adj_controlled_v(::bra::complex_type const& phase_coefficient, ::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit)
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_controlled_v::do_call(\
