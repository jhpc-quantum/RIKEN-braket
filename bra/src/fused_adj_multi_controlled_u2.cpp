...
namespace bra
{
  ...
  {
    fused_adj_multi_controlled_u2::fused_adj_multi_controlled_u2(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase1_{phase1}, phase2_{phase2}, target_qubit_{target_qubit}, control_qubits_{control_qubits}
    { }

    fused_adj_multi_controlled_u2::fused_adj_multi_controlled_u2(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits)
    ...
    [[noreturn]] auto fused_adj_multi_controlled_u2::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_multi_controlled_u2::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
