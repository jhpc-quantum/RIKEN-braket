...
namespace bra
{
  ...
  {
    fused_multi_controlled_exponential_swap::fused_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type > const& control_qubits)
    ...
    fused_multi_controlled_exponential_swap::fused_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type >&& control_qubits)
    ...
    [[noreturn]] auto fused_multi_controlled_exponential_swap::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_multi_controlled_exponential_swap::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
