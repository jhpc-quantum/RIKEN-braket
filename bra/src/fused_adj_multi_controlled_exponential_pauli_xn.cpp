...
# define CALL_ADJ_EXPONENTIAL_PAULI_X(z, num_control_qubits, num_target_qubits) \
    ...
    auto fused_adj_multi_controlled_exponential_pauli_xn<Iterator>::call_adj_exponential_pauli_x_ ## num_target_qubits ## _ ## num_control_qubits(\
      Iterator const first, ::bra::state_integer_type const fused_index_wo_qubits,\
...
BOOST_PP_REPEAT_FROM_TO_ ## z(0, BOOST_PP_INC(BOOST_PP_SUB(BRA_MAX_NUM_FUSED_QUBITS, num_target_qubits)), CALL_ADJ_EXPONENTIAL_PAULI_X, num_target_qubits)
...
# define CASE_CN(z, num_control_qubits, num_target_qubits) \
         case num_control_qubits:\
          call_adj_exponential_pauli_x_ ## num_target_qubits ## _ ## num_control_qubits(\
...
#undef CASE_CN
    ...
    template <typename Iterator>
    auto fused_adj_multi_controlled_exponential_pauli_xn<Iterator>::do_disable_control_qubits(
