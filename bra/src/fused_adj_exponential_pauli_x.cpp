...
namespace bra
{
  ...
  {
    fused_adj_exponential_pauli_x::fused_adj_exponential_pauli_x(::bra::real_type const phase, ::bra::qubit_type const qubit)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, qubit_{qubit}
    { }
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_exponential_pauli_x::do_call(\
