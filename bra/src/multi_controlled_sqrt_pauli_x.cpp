...
namespace bra
{
  namespace gate
  {
    multi_controlled_sqrt_pauli_x::multi_controlled_sqrt_pauli_x(
    ...
    ::bra::state& multi_controlled_sqrt_pauli_x::do_apply(::bra::state& state) const
    { return state.multi_controlled_sqrt_pauli_x(target_qubit_, control_qubits_); }

    std::string const& multi_controlled_sqrt_pauli_x::do_name() const { return name_; }
    std::string multi_controlled_sqrt_pauli_x::do_representation(
