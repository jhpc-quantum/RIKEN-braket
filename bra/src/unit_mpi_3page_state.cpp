...
namespace bra
{
  unsigned int unit_mpi_3page_state::do_num_page_qubits() const
  { return 3u; }

  unsigned int unit_mpi_3page_state::do_num_pages() const
  { return 8u; }

  unit_mpi_3page_state::unit_mpi_3page_state(
  ...
  void unit_mpi_3page_state::do_hadamard(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_hadamard(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_pauli_x(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_pauli_x(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_pauli_y(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_pauli_y(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_pauli_z(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_pauli_z(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_u1(real_type const phase, qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_u1(real_type const phase, qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_u2(
  ...
  void unit_mpi_3page_state::do_adj_u2(
    real_type const phase1, real_type const phase2, qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_u3(
  ...
  void unit_mpi_3page_state::do_adj_u3(
    real_type const phase1, real_type const phase2, real_type const phase3,
    qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_phase_shift(
  ...
  void unit_mpi_3page_state::do_adj_phase_shift(
    complex_type const phase_coefficient, qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_x_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_x_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_y_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_y_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void unit_mpi_3page_state::do_controlled_not(
  ...
  void unit_mpi_3page_state::do_adj_controlled_not(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
  ...
  void unit_mpi_3page_state::do_controlled_phase_shift(
  ...
  void unit_mpi_3page_state::do_adj_controlled_phase_shift(
    complex_type const phase_coefficient,
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
  ...
  void unit_mpi_3page_state::do_controlled_v(
    complex_type const phase_coefficient,
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
  ...
  void unit_mpi_3page_state::do_adj_controlled_v(
    complex_type const phase_coefficient,
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
  ...
  void unit_mpi_3page_state::do_toffoli(
  ...
  void unit_mpi_3page_state::do_adj_toffoli(
    qubit_type const target_qubit,
    control_qubit_type const control_qubit1, control_qubit_type const control_qubit2)
  {
  ...
  ::ket::gate::outcome unit_mpi_3page_state::do_projective_measurement(
  ...
  void unit_mpi_3page_state::do_expectation_values(yampi::rank const root)
  {
  ...
  void unit_mpi_3page_state::do_measure(yampi::rank const root)
  {
    measured_value_
      = ket::mpi::measure(
  ...
  void unit_mpi_3page_state::do_generate_events(yampi::rank const root, int const num_events, int const seed)
  {
    if (seed < 0)
  ...
  void unit_mpi_3page_state::do_shor_box(
  ...
  void unit_mpi_3page_state::do_clear(qubit_type const qubit)
  {
    ket::mpi::gate::clear(
      mpi_policy_, parallel_policy_,
      data_, qubit, permutation_, buffer_, communicator_, environment_);
  ...
  void unit_mpi_3page_state::do_set(qubit_type const qubit)
  {
    ket::mpi::gate::set(
      mpi_policy_, parallel_policy_,
      data_, qubit, permutation_, buffer_, communicator_, environment_);
