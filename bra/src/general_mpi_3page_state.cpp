...
namespace bra
{
  ...
  void general_mpi_3page_state::do_hadamard(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_hadamard(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_pauli_x(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_pauli_x(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_pauli_y(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_pauli_y(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_pauli_z(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_pauli_z(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_x_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_x_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_y_rotation_half_pi(qubit_type const qubit)
  {
  ...
  void general_mpi_3page_state::do_adj_y_rotation_half_pi(qubit_type const qubit)
  {
  ...
  ::ket::gate::outcome general_mpi_3page_state::do_projective_measurement(
