...
namespace bra
{
  namespace gate
  {
    multi_controlled_exponential_pauli_z::multi_controlled_exponential_pauli_z(
    ...
    ::bra::state& multi_controlled_exponential_pauli_z::do_apply(::bra::state& state) const
    { return state.multi_controlled_exponential_pauli_z(phase_, target_qubit_, control_qubits_); }

    std::string const& multi_controlled_exponential_pauli_z::do_name() const { return name_; }
    std::string multi_controlled_exponential_pauli_z::do_representation(
