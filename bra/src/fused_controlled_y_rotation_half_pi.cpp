...
namespace bra
{
  ...
  {
    fused_controlled_y_rotation_half_pi::fused_controlled_y_rotation_half_pi(::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit)
      : ::bra::fused_gate::fused_gate{}, target_qubit_{target_qubit}, control_qubit_{control_qubit}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_controlled_y_rotation_half_pi::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_controlled_y_rotation_half_pi::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
