...
namespace bra
{
  namespace fused_gate
  {
    ...
    fused_controlled_exponential_pauli_z<Iterator>::fused_controlled_exponential_pauli_z(::bra::real_type const phase, ::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit)
      : ::bra::fused_gate::fused_gate<Iterator>{}, phase_{phase}, target_qubit_{target_qubit}, control_qubit_{control_qubit}, qubit_state_{::bra::fused_gate::cez_qubit_state::not_global}, is_control_qubit_enabled_{true}
    { }
