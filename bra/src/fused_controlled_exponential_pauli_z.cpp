...
# define DO_CALL(z, num_fused_qubits, _) \
    ...
    { ::ket::gate::fused::exponential_pauli_z(first, fused_index_wo_qubits, unsorted_fused_qubits, sorted_fused_qubits_with_sentinel, phase_, target_qubit_, control_qubit_); }
#else // KET_USE_BIT_MASKS_EXPLICITLY
# define DO_CALL(z, num_fused_qubits, _) \
    template <typename Iterator>\
    auto fused_controlled_exponential_pauli_z<Iterator>::do_call(\
    ...
    { ::ket::gate::fused::exponential_pauli_z(first, fused_index_wo_qubits, qubit_masks, index_masks, phase_, target_qubit_, control_qubit_); }
#endif // KET_USE_BIT_MASKS_EXPLICITLY
