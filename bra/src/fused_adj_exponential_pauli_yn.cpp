...
namespace bra
{
  ...
  {
    fused_adj_exponential_pauli_yn::fused_adj_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, qubits_{qubits}
    { }

    fused_adj_exponential_pauli_yn::fused_adj_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, qubits_{std::move(qubits)}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_adj_exponential_pauli_yn::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_exponential_pauli_yn::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
