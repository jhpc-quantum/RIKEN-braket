...
namespace bra
{
  ...
  {
    fused_controlled_u3::fused_controlled_u3(::bra::real_type const phase1, ::bra::real_type const phase2, ::bra::real_type const phase3, ::bra::qubit_type const target_qubit, ::bra::control_qubit_type const control_qubit)
    ...
    [[noreturn]] auto fused_controlled_u3::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_controlled_u3::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
