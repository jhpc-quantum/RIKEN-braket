...
# endif
  ...
  void paged_simple_mpi_state::do_adj_i_gate(qubit_type const qubit)
  {
    if (is_in_fusion_)
      return;
  ...
  void paged_simple_mpi_state::do_adj_ii_gate(qubit_type const qubit1, qubit_type const qubit2)
  {
    if (is_in_fusion_)
      return;
...
# undef QUBITS
  ...
  void paged_simple_mpi_state::do_adj_in_gate(std::vector<qubit_type> const& qubits)
  {
    if (is_in_fusion_)
      return;
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  void paged_simple_mpi_state::do_sqrt_pauli_z(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  void paged_simple_mpi_state::do_adj_sqrt_pauli_z(qubit_type const qubit)
  {
    if (is_in_fusion_)
    {
...
# endif // defined(KET_ENABLE_CACHE_AWARE_GATE_FUNCTION) && !defined(KET_USE_ON_CACHE_STATE_VECTOR)
  ...
  void paged_simple_mpi_state::do_adj_controlled_i_gate(
    qubit_type const target_qubit, control_qubit_type const control_qubit)
  {
    if (is_in_fusion_)
      return;
