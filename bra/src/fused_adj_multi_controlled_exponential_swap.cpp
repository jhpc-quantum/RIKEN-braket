...
namespace bra
{
  ...
  {
    fused_adj_multi_controlled_exponential_swap::fused_adj_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubit1_{target_qubit1}, target_qubit2_{target_qubit2}, control_qubits_{control_qubits}
    { }

    fused_adj_multi_controlled_exponential_swap::fused_adj_multi_controlled_exponential_swap(::bra::real_type const phase, ::bra::qubit_type const target_qubit1, ::bra::qubit_type const target_qubit2, std::vector< ::bra::control_qubit_type >&& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubit1_{target_qubit1}, target_qubit2_{target_qubit2}, control_qubits_{std::move(control_qubits)}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_adj_multi_controlled_exponential_swap::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_multi_controlled_exponential_swap::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
