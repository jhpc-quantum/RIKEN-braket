...
namespace bra
{
  ...
  {
    fused_adj_multi_controlled_u1::fused_adj_multi_controlled_u1(::bra::real_type const phase, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubit_{target_qubit}, control_qubits_{control_qubits}
    { }

    fused_adj_multi_controlled_u1::fused_adj_multi_controlled_u1(::bra::real_type const phase, ::bra::qubit_type const target_qubit, std::vector< ::bra::control_qubit_type >&& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubit_{target_qubit}, control_qubits_{std::move(control_qubits)}
    { }

#ifndef KET_USE_BIT_MASKS_EXPLICITLY
    [[noreturn]] auto fused_adj_multi_controlled_u1::do_call(
...
# define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_multi_controlled_u1::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
