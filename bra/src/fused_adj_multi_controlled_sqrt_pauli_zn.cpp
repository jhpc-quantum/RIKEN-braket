...
# define CALL_ADJ_SQRT_PAULI_Z(z, num_control_qubits, num_target_qubits) \
    ...
    auto fused_adj_multi_controlled_sqrt_pauli_zn<Iterator>::call_adj_sqrt_pauli_z_ ## num_target_qubits ## _ ## num_control_qubits(\
      Iterator const first, ::bra::state_integer_type const fused_index_wo_qubits,\
...
# define CASE_CN(z, num_control_qubits, num_target_qubits) \
         case num_control_qubits:\
          call_adj_sqrt_pauli_z_ ## num_target_qubits ## _ ## num_control_qubits(\
...
#undef CASE_CN
    ...
    template <typename Iterator>
    auto fused_adj_multi_controlled_sqrt_pauli_zn<Iterator>::do_disable_control_qubits(
