...
namespace bra
{
  ...
  {
    fused_adj_multi_controlled_exponential_pauli_yn::fused_adj_multi_controlled_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubits_{target_qubits}, control_qubits_{control_qubits}
    { }

    fused_adj_multi_controlled_exponential_pauli_yn::fused_adj_multi_controlled_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type > const& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubits_{std::move(target_qubits)}, control_qubits_{control_qubits}
    { }

    fused_adj_multi_controlled_exponential_pauli_yn::fused_adj_multi_controlled_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type > const& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits)
      : ::bra::fused_gate::fused_gate{}, phase_{phase}, target_qubits_{target_qubits}, control_qubits_{std::move(control_qubits)}
    { }

    fused_adj_multi_controlled_exponential_pauli_yn::fused_adj_multi_controlled_exponential_pauli_yn(::bra::real_type const phase, std::vector< ::bra::qubit_type >&& target_qubits, std::vector< ::bra::control_qubit_type >&& control_qubits)
    ...
    [[noreturn]] auto fused_adj_multi_controlled_exponential_pauli_yn::do_call(
...
#define DO_CALL(z, num_fused_qubits, _) \
    auto fused_adj_multi_controlled_exponential_pauli_yn::do_call(\
      ::bra::complex_type* const first, ::bra::state_integer_type const fused_index_wo_qubits,\
