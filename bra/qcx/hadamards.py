...
def main(num_qubits: int, is_in_descending_order: bool, adds_measurement: bool, adds_amplitudes: bool, bit_assignment: str, file) -> None:
...
if __name__ == '__main__':
    ...
    if args.output:
        with open(args.output, mode='w') as file:
            main(args.num_qubits, args.descend, args.measure, args.amplitudes, args.bitassign, file)
    else:
        main(args.num_qubits, args.descend, args.measure, args.amplitudes, args.bitassign, sys.stdout)
